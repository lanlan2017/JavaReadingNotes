...
<div style="border-style:solid;">注意：为了在Config Server中使用加密功能，我们需要要安装JavaCryptography Extensions Unlimited Strength策略文件。参见Oracle的JavaSE页面了解详细信息。</div>
...
<div style="border-style:solid;">注意：Vault是一个功能完备且健壮的私密管理工具。除了开发模式下的简单使用之外，本章没有足够的篇幅完整介绍Vault服务器的运行。我强烈建议你在尝试生产环境中使用Vault之前，通过阅读Vaul文档来更详细地了解Vault。</div>
