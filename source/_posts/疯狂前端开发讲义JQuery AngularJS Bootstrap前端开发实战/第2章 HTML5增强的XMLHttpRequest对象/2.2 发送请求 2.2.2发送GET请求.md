...
- [2.2 发送请求 2.2.2发送GET请求](/JavaReadingNotes/d523be76/#2-2-发送请求-2-2-2发送GET请求)
    - [通常情况下](/JavaReadingNotes/d523be76/#通常情况下)
    - [使用Ajax](/JavaReadingNotes/d523be76/#使用Ajax)
    - [实例](/JavaReadingNotes/d523be76/#实例)
