...
- [3.6 动画效果相关的方法](/JavaReadingNotes/994a13a/#3-6-动画效果相关的方法)
- [3.6.1 简单动画和复杂动画](/JavaReadingNotes/994a13a/#3-6-1-简单动画和复杂动画)
    - [简单动画](/JavaReadingNotes/994a13a/#简单动画)
        - [显示和隐藏方法](/JavaReadingNotes/994a13a/#显示和隐藏方法)
        - [以动画方式增加或减少高度](/JavaReadingNotes/994a13a/#以动画方式增加或减少高度)
        - [不断增加或减少透明度](/JavaReadingNotes/994a13a/#不断增加或减少透明度)
        - [上述方法支持的参数](/JavaReadingNotes/994a13a/#上述方法支持的参数)
        - [程序示例](/JavaReadingNotes/994a13a/#程序示例)
    - [复杂动画](/JavaReadingNotes/994a13a/#复杂动画)
        - [animate方法的第2种形式](/JavaReadingNotes/994a13a/#animate方法的第2种形式)
        - [程序示例](/JavaReadingNotes/994a13a/#程序示例)
    - [动画效果全局属性](/JavaReadingNotes/994a13a/#动画效果全局属性)
