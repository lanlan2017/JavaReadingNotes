...
- [3.1.3 让jQuery与其他JavaScript库共存](/JavaReadingNotes/66cebcc1/#3-1-3-让jQuery与其他JavaScript库共存)
    - [美元函数冲突](/JavaReadingNotes/66cebcc1/#美元函数冲突)
    - [如何解决美元函数冲突](/JavaReadingNotes/66cebcc1/#如何解决美元函数冲突)
    - [为jQuery函数写别名](/JavaReadingNotes/66cebcc1/#为jQuery函数写别名)
