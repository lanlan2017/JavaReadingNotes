...
- [3.4.4 操作CSS属性的相关方法](/JavaReadingNotes/d621454c/#3-4-4-操作CSS属性的相关方法)
    - [操作CSS属性的方法](/JavaReadingNotes/d621454c/#操作CSS属性的方法)
        - [操作DOM的class属性的方法](/JavaReadingNotes/d621454c/#操作DOM的class属性的方法)
        - [css方法](/JavaReadingNotes/d621454c/#css方法)
        - [获取给定属性名称对应的属性值](/JavaReadingNotes/d621454c/#获取给定属性名称对应的属性值)
        - [设置属性值](/JavaReadingNotes/d621454c/#设置属性值)
        - [获取相对位置的方法](/JavaReadingNotes/d621454c/#获取相对位置的方法)
        - [获取和设置垂直滚动条的方法](/JavaReadingNotes/d621454c/#获取和设置垂直滚动条的方法)
        - [获取和设置水平滚动条的方法](/JavaReadingNotes/d621454c/#获取和设置水平滚动条的方法)
        - [获取和设置当前元素的高度和宽度](/JavaReadingNotes/d621454c/#获取和设置当前元素的高度和宽度)
        - [获取和设置内部高度或外部高度的方法](/JavaReadingNotes/d621454c/#获取和设置内部高度或外部高度的方法)
    - [程序示例](/JavaReadingNotes/d621454c/#程序示例)
    - [创建自定义的CSS属性](/JavaReadingNotes/d621454c/#创建自定义的CSS属性)
    - [程序示例](/JavaReadingNotes/d621454c/#程序示例)
