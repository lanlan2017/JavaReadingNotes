...
- [3.8.3 jQuery.ajax(options)方法与jQuery.ajaxSetup(options)方法](/JavaReadingNotes/bc7cacaa/#3-8-3-jQuery-ajax-options-方法与jQuery-ajaxSetup-options-方法)
    - [ajax函数的参数](/JavaReadingNotes/bc7cacaa/#ajax函数的参数)
        - [ajax函数选项](/JavaReadingNotes/bc7cacaa/#ajax函数选项)
            - [password选项](/JavaReadingNotes/bc7cacaa/#password选项)
                - [password选项](/JavaReadingNotes/bc7cacaa/#password选项)
            - [username选项](/JavaReadingNotes/bc7cacaa/#username选项)
                - [username选项](/JavaReadingNotes/bc7cacaa/#username选项)
        - [响应相关选项](/JavaReadingNotes/bc7cacaa/#响应相关选项)
        - [其他选项](/JavaReadingNotes/bc7cacaa/#其他选项)
    - [如何设置全局Ajax选项](/JavaReadingNotes/bc7cacaa/#如何设置全局Ajax选项)
