...
- [3.8.4 使用get或post方法](/JavaReadingNotes/f476211b/#3-8-4-使用get或post方法)
    - [发送get请求](/JavaReadingNotes/f476211b/#发送get请求)
        - [get方法](/JavaReadingNotes/f476211b/#get方法)
        - [getJSON方法](/JavaReadingNotes/f476211b/#getJSON方法)
        - [getScript方法](/JavaReadingNotes/f476211b/#getScript方法)
    - [程序示例](/JavaReadingNotes/f476211b/#程序示例)
        - [使用get方法](/JavaReadingNotes/f476211b/#使用get方法)
        - [使用getScript方法](/JavaReadingNotes/f476211b/#使用getScript方法)
    - [发送POST请求](/JavaReadingNotes/f476211b/#发送POST请求)
        - [什么使用用get方法什么时候用post方法](/JavaReadingNotes/f476211b/#什么使用用get方法什么时候用post方法)
