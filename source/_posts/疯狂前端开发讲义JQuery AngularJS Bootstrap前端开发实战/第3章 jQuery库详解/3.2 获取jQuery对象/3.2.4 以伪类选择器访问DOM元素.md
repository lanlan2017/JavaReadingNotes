...
- [3.2.4 以伪类选择器访问DOM元素](/JavaReadingNotes/5544972c/#3-2-4-以伪类选择器访问DOM元素)
    - [伪类选择符](/JavaReadingNotes/5544972c/#伪类选择符)
        - [索引相关伪类选择符](/JavaReadingNotes/5544972c/#索引相关伪类选择符)
        - [内容相关的伪类选择符](/JavaReadingNotes/5544972c/#内容相关的伪类选择符)
        - [包内其他内容相关的选择符](/JavaReadingNotes/5544972c/#包内其他内容相关的选择符)
        - [可见性相关的伪类选择符](/JavaReadingNotes/5544972c/#可见性相关的伪类选择符)
        - [其他](/JavaReadingNotes/5544972c/#其他)
    - [程序示例](/JavaReadingNotes/5544972c/#程序示例)
    - [:lang伪类选择器](/JavaReadingNotes/5544972c/#-lang伪类选择器)
    - [子代伪类选择器](/JavaReadingNotes/5544972c/#子代伪类选择器)
        - [:nth-child伪类选择器](/JavaReadingNotes/5544972c/#-nth-child伪类选择器)
        - [程序示例](/JavaReadingNotes/5544972c/#程序示例)
    - [XXX-of-type伪类选择器](/JavaReadingNotes/5544972c/#XXX-of-type伪类选择器)
        - [:nth-child和:nth-of-type的异同](/JavaReadingNotes/5544972c/#-nth-child和-nth-of-type的异同)
        - [程序示例](/JavaReadingNotes/5544972c/#程序示例)
