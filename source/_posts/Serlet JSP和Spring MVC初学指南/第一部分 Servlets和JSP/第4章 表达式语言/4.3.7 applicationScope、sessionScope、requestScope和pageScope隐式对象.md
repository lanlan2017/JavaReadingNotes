...
- [4.3.7 applicationScope、sessionScope、requestScope和pageScope隐式对象](/JavaReadingNotes/436620c4/#4-3-7-applicationScope、sessionScope、requestScope和pageScope隐式对象)
    - [有界对象](/JavaReadingNotes/436620c4/#有界对象)
