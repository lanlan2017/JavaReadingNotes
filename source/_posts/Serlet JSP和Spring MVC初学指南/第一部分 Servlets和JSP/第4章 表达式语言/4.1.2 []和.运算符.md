...
- [4.1.2 []和.运算符](/JavaReadingNotes/1b51864b/#4-1-2-[]和-运算符)
    - [EL表达式如何访问对象的属性](/JavaReadingNotes/1b51864b/#EL表达式如何访问对象的属性)
    - [当表达式中对象的属性也是对象的情况 EL链式访问](/JavaReadingNotes/1b51864b/#当表达式中对象的属性也是对象的情况-EL链式访问)
