...
- [1.6 ServletConfig接口](/JavaReadingNotes/6208eca0/#1-6-ServletConfig接口)
    - [接口方法](/JavaReadingNotes/6208eca0/#接口方法)
    - [接口描述](/JavaReadingNotes/6208eca0/#接口描述)
- [实例](/JavaReadingNotes/6208eca0/#实例)
    - [运行效果](/JavaReadingNotes/6208eca0/#运行效果)
    - [部署描述符中设置Servlet的初始化参数](/JavaReadingNotes/6208eca0/#部署描述符中设置Servlet的初始化参数)
- [总结](/JavaReadingNotes/6208eca0/#总结)
