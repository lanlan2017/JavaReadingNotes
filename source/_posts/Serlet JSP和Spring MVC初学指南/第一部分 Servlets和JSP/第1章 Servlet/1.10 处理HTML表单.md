...
- [1.10 处理HTML表单](/JavaReadingNotes/5aff9168/#1-10-处理HTML表单)
    - [select元素](/JavaReadingNotes/5aff9168/#select元素)
    - [复选框](/JavaReadingNotes/5aff9168/#复选框)
    - [单选框](/JavaReadingNotes/5aff9168/#单选框)
    - [多个同名元素的情况](/JavaReadingNotes/5aff9168/#多个同名元素的情况)
- [实例](/JavaReadingNotes/5aff9168/#实例)
    - [总结](/JavaReadingNotes/5aff9168/#总结)
