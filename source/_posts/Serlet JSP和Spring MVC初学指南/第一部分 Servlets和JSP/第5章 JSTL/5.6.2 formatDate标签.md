...
- [5.6.2 formatDate标签](/JavaReadingNotes/a7bd1fb5/#5-6-2-formatDate标签)
    - [引用格式化标签库](/JavaReadingNotes/a7bd1fb5/#引用格式化标签库)
    - [formatDate标签语法格式](/JavaReadingNotes/a7bd1fb5/#formatDate标签语法格式)
    - [formatDate标签的属性](/JavaReadingNotes/a7bd1fb5/#formatDate标签的属性)
- [实例](/JavaReadingNotes/a7bd1fb5/#实例)
    - [设置日期属性](/JavaReadingNotes/a7bd1fb5/#设置日期属性)
    - [格式化日期](/JavaReadingNotes/a7bd1fb5/#格式化日期)
    - [格式化时间](/JavaReadingNotes/a7bd1fb5/#格式化时间)
    - [格式化时间和日期](/JavaReadingNotes/a7bd1fb5/#格式化时间和日期)
    - [格式化带时区的时间](/JavaReadingNotes/a7bd1fb5/#格式化带时区的时间)
    - [使用自定义格式来格式化时间和日期](/JavaReadingNotes/a7bd1fb5/#使用自定义格式来格式化时间和日期)
