...
- [5.7 函数](/JavaReadingNotes/a7b90af6/#5-7-函数)
- [5.7.1 contains函数](/JavaReadingNotes/a7b90af6/#5-7-1-contains函数)
    - [实例](/JavaReadingNotes/a7b90af6/#实例)
    - [完整代码](/JavaReadingNotes/a7b90af6/#完整代码)
- [5.7.2 containsIgnoreCase函数](/JavaReadingNotes/a7b90af6/#5-7-2-containsIgnoreCase函数)
- [5.7.3 endsWith函数](/JavaReadingNotes/a7b90af6/#5-7-3-endsWith函数)
- [5.7.4 escapeXml函数](/JavaReadingNotes/a7b90af6/#5-7-4-escapeXml函数)
- [5.7.5 indexOf函数](/JavaReadingNotes/a7b90af6/#5-7-5-indexOf函数)
- [5.7.6 join函数](/JavaReadingNotes/a7b90af6/#5-7-6-join函数)
- [5.7.7 length函数](/JavaReadingNotes/a7b90af6/#5-7-7-length函数)
- [5.7.8 replace函数](/JavaReadingNotes/a7b90af6/#5-7-8-replace函数)
- [5.7.9 split函数](/JavaReadingNotes/a7b90af6/#5-7-9-split函数)
- [5.7.10 startsWith函数](/JavaReadingNotes/a7b90af6/#5-7-10-startsWith函数)
- [5.7.12 substringAfter函数](/JavaReadingNotes/a7b90af6/#5-7-12-substringAfter函数)
- [5.7.13 substringBefore函数](/JavaReadingNotes/a7b90af6/#5-7-13-substringBefore函数)
- [5.7.14 toLowerCase函数](/JavaReadingNotes/a7b90af6/#5-7-14-toLowerCase函数)
- [5.7.15 toUpperCase函数](/JavaReadingNotes/a7b90af6/#5-7-15-toUpperCase函数)
- [5.7.16 trim函数](/JavaReadingNotes/a7b90af6/#5-7-16-trim函数)
