...
- [5.6 格式化行为](/JavaReadingNotes/9233bec0/#5-6-格式化行为)
    - [引用格式化标签库](/JavaReadingNotes/9233bec0/#引用格式化标签库)
- [5.6.1 formatNumber标签](/JavaReadingNotes/9233bec0/#5-6-1-formatNumber标签)
    - [formatNumber标签的属性](/JavaReadingNotes/9233bec0/#formatNumber标签的属性)
    - [格式化样式pattern说明](/JavaReadingNotes/9233bec0/#格式化样式pattern说明)
    - [formatNumber的用法范例](/JavaReadingNotes/9233bec0/#formatNumber的用法范例)
