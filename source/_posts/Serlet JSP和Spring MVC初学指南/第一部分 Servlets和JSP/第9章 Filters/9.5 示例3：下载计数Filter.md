...
- [9.5 示例3：下载计数Filter](/JavaReadingNotes/cdb49d4c/#9-5-示例3：下载计数Filter)
    - [DownloadCounterFilter.java](/JavaReadingNotes/cdb49d4c/#DownloadCounterFilter-java)
    - [代码详解](/JavaReadingNotes/cdb49d4c/#代码详解)
        - [init方法](/JavaReadingNotes/cdb49d4c/#init方法)
        - [destroy方法](/JavaReadingNotes/cdb49d4c/#destroy方法)
        - [doFilter方法](/JavaReadingNotes/cdb49d4c/#doFilter方法)
    - [运行效果](/JavaReadingNotes/cdb49d4c/#运行效果)
