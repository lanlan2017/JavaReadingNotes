...
- [12.1.2 实施安全约束](/JavaReadingNotes/396d2c/#12-1-2-实施安全约束)
    - [security-constraint元素说明](/JavaReadingNotes/396d2c/#security-constraint元素说明)
        - [web-resource-collection子元素](/JavaReadingNotes/396d2c/#web-resource-collection子元素)
        - [auth-constraint子元素](/JavaReadingNotes/396d2c/#auth-constraint子元素)
    - [实例:禁止访问特定目录下的资源](/JavaReadingNotes/396d2c/#实例-禁止访问特定目录下的资源)
        - [web.xml](/JavaReadingNotes/396d2c/#web-xml)
        - [1.jsp](/JavaReadingNotes/396d2c/#1-jsp)
        - [运行效果](/JavaReadingNotes/396d2c/#运行效果)
    - [参考资料](/JavaReadingNotes/396d2c/#参考资料)
