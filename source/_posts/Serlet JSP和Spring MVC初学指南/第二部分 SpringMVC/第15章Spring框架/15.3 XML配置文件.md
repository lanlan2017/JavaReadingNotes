...
- [15.3 XML配置文件](/JavaReadingNotes/93d025a0/#15-3-XML配置文件)
    - [使用XML文件配置beans](/JavaReadingNotes/93d025a0/#使用XML文件配置beans)
    - [beans的xml文件导入其他被子beans的xml文件](/JavaReadingNotes/93d025a0/#beans的xml文件导入其他被子beans的xml文件)
