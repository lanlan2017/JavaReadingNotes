...
- [15.4 Spring控制反转容器的使用](/JavaReadingNotes/5bf98c16/#15-4-Spring控制反转容器的使用)
    - [15.4.1 通过构造器创建一个bean实例](/JavaReadingNotes/5bf98c16/#15-4-1-通过构造器创建一个bean实例)
        - [一个简单的配置文件](/JavaReadingNotes/5bf98c16/#一个简单的配置文件)
    - [15.4.2 通过工厂方法创建一个bean实例](/JavaReadingNotes/5bf98c16/#15-4-2-通过工厂方法创建一个bean实例)
    - [15.4.3 DestroyMethod的使用](/JavaReadingNotes/5bf98c16/#15-4-3-DestroyMethod的使用)
    - [15.4.4 向构造器传递参数](/JavaReadingNotes/5bf98c16/#15-4-4-向构造器传递参数)
        - [Product类](/JavaReadingNotes/5bf98c16/#Product类)
    - [15.4.5 setter方式依赖注入](/JavaReadingNotes/5bf98c16/#15-4-5-setter方式依赖注入)
        - [Employee类](/JavaReadingNotes/5bf98c16/#Employee类)
        - [Address类](/JavaReadingNotes/5bf98c16/#Address类)
    - [15.4.6 构造器方式依赖注入](/JavaReadingNotes/5bf98c16/#15-4-6-构造器方式依赖注入)
- [完整代码](/JavaReadingNotes/5bf98c16/#完整代码)
    - [项目结构](/JavaReadingNotes/5bf98c16/#项目结构)
    - [spring-config.xml](/JavaReadingNotes/5bf98c16/#spring-config-xml)
    - [Main.java](/JavaReadingNotes/5bf98c16/#Main-java)
