...
- [17.4 第一个Spring MVC应用](/JavaReadingNotes/c5474bdb/#17-4-第一个Spring-MVC应用)
    - [17.4.1 目录结构](/JavaReadingNotes/c5474bdb/#17-4-1-目录结构)
- [17.4.2 部署描述符文件和Spring MVC配置文件](/JavaReadingNotes/c5474bdb/#17-4-2-部署描述符文件和Spring-MVC配置文件)
    - [部署描述符（web.xml）文件](/JavaReadingNotes/c5474bdb/#部署描述符（web-xml）文件)
        - [Spring MVC配置文件springmvc-servlet.xml](/JavaReadingNotes/c5474bdb/#Spring-MVC配置文件springmvc-servlet-xml)
    - [17.4.3 Controller](/JavaReadingNotes/c5474bdb/#17-4-3-Controller)
        - [InputProductController类](/JavaReadingNotes/c5474bdb/#InputProductController类)
        - [SaveProductController类](/JavaReadingNotes/c5474bdb/#SaveProductController类)
    - [17.4.4 View](/JavaReadingNotes/c5474bdb/#17-4-4-View)
        - [ProductForm.jsp页面](/JavaReadingNotes/c5474bdb/#ProductForm-jsp页面)
        - [ProductDetails.jsp页面](/JavaReadingNotes/c5474bdb/#ProductDetails-jsp页面)
    - [17.4.5 测试应用](/JavaReadingNotes/c5474bdb/#17-4-5-测试应用)
