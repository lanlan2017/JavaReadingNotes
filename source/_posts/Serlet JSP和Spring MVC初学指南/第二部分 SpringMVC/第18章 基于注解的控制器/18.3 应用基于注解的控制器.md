...
- [18.3 应用基于注解的控制器](/JavaReadingNotes/ad3082bb/#18-3-应用基于注解的控制器)
    - [18.3.1 目录结构](/JavaReadingNotes/ad3082bb/#18-3-1-目录结构)
    - [18.3.2 配置文件](/JavaReadingNotes/ad3082bb/#18-3-2-配置文件)
        - [app18a（web.xml）的部署描述符](/JavaReadingNotes/ad3082bb/#app18a（web-xml）的部署描述符)
        - [springmvc-config.xml文件](/JavaReadingNotes/ad3082bb/#springmvc-config-xml文件)
    - [18.3.3 Controller类](/JavaReadingNotes/ad3082bb/#18-3-3-Controller类)
        - [ProductController类](/JavaReadingNotes/ad3082bb/#ProductController类)
    - [18.3.4 View](/JavaReadingNotes/ad3082bb/#18-3-4-View)
        - [ProductForm.jsp页面](/JavaReadingNotes/ad3082bb/#ProductForm-jsp页面)
        - [ProductDetails.jsp页面](/JavaReadingNotes/ad3082bb/#ProductDetails-jsp页面)
    - [18.3.5 测试应用](/JavaReadingNotes/ad3082bb/#18-3-5-测试应用)
