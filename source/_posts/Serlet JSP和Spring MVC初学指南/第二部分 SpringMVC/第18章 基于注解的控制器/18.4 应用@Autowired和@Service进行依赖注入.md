...
- [18.4 应用@Autowired和@Service进行依赖注入](/JavaReadingNotes/2dfacbe6/#18-4-应用-Autowired和-Service进行依赖注入)
    - [app18b的ProductController类](/JavaReadingNotes/2dfacbe6/#app18b的ProductController类)
        - [ProductService接口](/JavaReadingNotes/2dfacbe6/#ProductService接口)
        - [ProductServiceImpl类](/JavaReadingNotes/2dfacbe6/#ProductServiceImpl类)
    - [Spring MVC配置文件](/JavaReadingNotes/2dfacbe6/#Spring-MVC配置文件)
        - [SpringMVC配置文件](/JavaReadingNotes/2dfacbe6/#SpringMVC配置文件)
