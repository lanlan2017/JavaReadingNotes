...
- [18.2 编写请求处理方法](/JavaReadingNotes/f9091724/#18-2-编写请求处理方法)
    - [允许作为请求处理方法的参数的类型](/JavaReadingNotes/f9091724/#允许作为请求处理方法的参数的类型)
    - [请求处理方法可以返回的类型](/JavaReadingNotes/f9091724/#请求处理方法可以返回的类型)
