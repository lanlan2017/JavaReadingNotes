...
- [9.3.4 代理模式](/JavaReadingNotes/3f9c663b/#9-3-4-代理模式)
- [程序示例](/JavaReadingNotes/3f9c663b/#程序示例)
    - [使用代理节省开销](/JavaReadingNotes/3f9c663b/#使用代理节省开销)
    - [代理对象增强目标对象的功能](/JavaReadingNotes/3f9c663b/#代理对象增强目标对象的功能)
    - [程序示例](/JavaReadingNotes/3f9c663b/#程序示例)
