...
- [9.3.2 简单工厂](/JavaReadingNotes/2cf2686e/#9-3-2-简单工厂)
    - [依赖关系](/JavaReadingNotes/2cf2686e/#依赖关系)
    - [硬编码耦合](/JavaReadingNotes/2cf2686e/#硬编码耦合)
- [程序示例](/JavaReadingNotes/2cf2686e/#程序示例)
    - [简单工厂模式的优势](/JavaReadingNotes/2cf2686e/#简单工厂模式的优势)
    - [工厂模式的缺陷](/JavaReadingNotes/2cf2686e/#工厂模式的缺陷)
- [实现简单的IoC容器功能](/JavaReadingNotes/2cf2686e/#实现简单的IoC容器功能)
