...
- [7.3.2 设值注入](/JavaReadingNotes/37d15e90/#7-3-2-设值注入)
- [程序示例](/JavaReadingNotes/37d15e90/#程序示例)
    - [项目结构](/JavaReadingNotes/37d15e90/#项目结构)
    - [Person.java](/JavaReadingNotes/37d15e90/#Person-java)
    - [Axe.java](/JavaReadingNotes/37d15e90/#Axe-java)
    - [Chinese.java](/JavaReadingNotes/37d15e90/#Chinese-java)
    - [SteelAxe.java](/JavaReadingNotes/37d15e90/#SteelAxe-java)
    - [beans.xml](/JavaReadingNotes/37d15e90/#beans-xml)
    - [SteelAxe.java](/JavaReadingNotes/37d15e90/#SteelAxe-java)
    - [设值注入](/JavaReadingNotes/37d15e90/#设值注入)
    - [Spring IoC容器的三个基本要点](/JavaReadingNotes/37d15e90/#Spring-IoC容器的三个基本要点)
