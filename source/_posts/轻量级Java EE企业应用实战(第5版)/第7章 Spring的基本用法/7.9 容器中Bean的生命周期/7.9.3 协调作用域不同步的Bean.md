...
- [7.9.3 协调作用域不同步的Bean](/JavaReadingNotes/d6fbfb2c/#7-9-3-协调作用域不同步的Bean)
    - [如何解决singleton作用域依赖prototype作用域时的不同步现象](/JavaReadingNotes/d6fbfb2c/#如何解决singleton作用域依赖prototype作用域时的不同步现象)
    - [推荐使用方法注入](/JavaReadingNotes/d6fbfb2c/#推荐使用方法注入)
    - [方法注入](/JavaReadingNotes/d6fbfb2c/#方法注入)
    - [使用lookup方法注入的步骤](/JavaReadingNotes/d6fbfb2c/#使用lookup方法注入的步骤)
- [程序示例](/JavaReadingNotes/d6fbfb2c/#程序示例)
    - [项目结构](/JavaReadingNotes/d6fbfb2c/#项目结构)
    - [Chinese.java](/JavaReadingNotes/d6fbfb2c/#Chinese-java)
    - [lookup-method元素属性](/JavaReadingNotes/d6fbfb2c/#lookup-method元素属性)
    - [beans.xml](/JavaReadingNotes/d6fbfb2c/#beans-xml)
    - [Spring实现方法的逻辑](/JavaReadingNotes/d6fbfb2c/#Spring实现方法的逻辑)
    - [Spring实现方法的方式](/JavaReadingNotes/d6fbfb2c/#Spring实现方法的方式)
    - [SpringTest.java](/JavaReadingNotes/d6fbfb2c/#SpringTest-java)
    - [运行结果](/JavaReadingNotes/d6fbfb2c/#运行结果)
    - [lookup注入的目标Bean必须设为prototype作用域](/JavaReadingNotes/d6fbfb2c/#lookup注入的目标Bean必须设为prototype作用域)
