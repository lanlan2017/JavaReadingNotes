...
- [7.9 容器中Bean的生命周期](/JavaReadingNotes/d33b96f6/#7-9-容器中Bean的生命周期)
    - [Spring可以管理singleton作用域的Bean的生命周期](/JavaReadingNotes/d33b96f6/#Spring可以管理singleton作用域的Bean的生命周期)
    - [Spring无法管理prototype作用域的Bean](/JavaReadingNotes/d33b96f6/#Spring无法管理prototype作用域的Bean)
    - [管理Bean生命周期行为的时机](/JavaReadingNotes/d33b96f6/#管理Bean生命周期行为的时机)
