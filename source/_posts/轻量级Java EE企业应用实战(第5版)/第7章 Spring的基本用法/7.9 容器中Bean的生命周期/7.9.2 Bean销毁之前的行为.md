...
- [7.9.2 Bean销毁之前的行为](/JavaReadingNotes/1b49829a/#7-9-2-Bean销毁之前的行为)
- [程序示例](/JavaReadingNotes/1b49829a/#程序示例)
    - [项目结构](/JavaReadingNotes/1b49829a/#项目结构)
    - [Chinese.java](/JavaReadingNotes/1b49829a/#Chinese-java)
    - [beans.xml](/JavaReadingNotes/1b49829a/#beans-xml)
    - [Web应用关闭时会自动关闭Spring容器](/JavaReadingNotes/1b49829a/#Web应用关闭时会自动关闭Spring容器)
    - [在非Web环境如何关闭Spring容器](/JavaReadingNotes/1b49829a/#在非Web环境如何关闭Spring容器)
    - [如何注册关闭钩子来关闭Spring容器](/JavaReadingNotes/1b49829a/#如何注册关闭钩子来关闭Spring容器)
    - [BeanTest.java](/JavaReadingNotes/1b49829a/#BeanTest-java)
    - [运行结果](/JavaReadingNotes/1b49829a/#运行结果)
    - [不推荐实现DisposableBean接口方式](/JavaReadingNotes/1b49829a/#不推荐实现DisposableBean接口方式)
    - [先执行DisposableBean接口方法再执行destroy-method属性指定的方法](/JavaReadingNotes/1b49829a/#先执行DisposableBean接口方法再执行destroy-method属性指定的方法)
    - [在beans元素上为所有bean指定生命周期行为](/JavaReadingNotes/1b49829a/#在beans元素上为所有bean指定生命周期行为)
    - [Spring容器中Bean实例完整的生命周期行为](/JavaReadingNotes/1b49829a/#Spring容器中Bean实例完整的生命周期行为)
