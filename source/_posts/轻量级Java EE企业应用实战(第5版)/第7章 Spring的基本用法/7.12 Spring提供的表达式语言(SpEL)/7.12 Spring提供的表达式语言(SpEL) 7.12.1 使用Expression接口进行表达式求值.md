...
- [7.12 Spring提供的表达式语言(SpEL)](/JavaReadingNotes/443ff746/#7-12-Spring提供的表达式语言-SpEL)
- [7.12.1 使用Expression接口进行表达式求值](/JavaReadingNotes/443ff746/#7-12-1-使用Expression接口进行表达式求值)
    - [SpEL接口](/JavaReadingNotes/443ff746/#SpEL接口)
    - [Expression接口介绍](/JavaReadingNotes/443ff746/#Expression接口介绍)
- [程序示例](/JavaReadingNotes/443ff746/#程序示例)
    - [SpELTest.java](/JavaReadingNotes/443ff746/#SpELTest-java)
    - [往EvaluationContext里面放入变量](/JavaReadingNotes/443ff746/#往EvaluationContext里面放入变量)
    - [StandardEvaluationContext设置root对象](/JavaReadingNotes/443ff746/#StandardEvaluationContext设置root对象)
    - [Person.java](/JavaReadingNotes/443ff746/#Person-java)
