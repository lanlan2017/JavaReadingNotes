...
- [7.12.3 SpEL语法详述](/JavaReadingNotes/84ca0064/#7-12-3-SpEL语法详述)
    - [1. 直接量表达式](/JavaReadingNotes/84ca0064/#1-直接量表达式)
    - [2. 在表达式中创建数组](/JavaReadingNotes/84ca0064/#2-在表达式中创建数组)
    - [3. 在表达式中创建List集合](/JavaReadingNotes/84ca0064/#3-在表达式中创建List集合)
    - [4. 在表达式中访问List、Map等集合元素](/JavaReadingNotes/84ca0064/#4-在表达式中访问List、Map等集合元素)
    - [5. 调用方法](/JavaReadingNotes/84ca0064/#5-调用方法)
    - [6. 算术、比较、逻辑、赋值、三目等运算符](/JavaReadingNotes/84ca0064/#6-算术、比较、逻辑、赋值、三目等运算符)
    - [7. 类型运算符](/JavaReadingNotes/84ca0064/#7-类型运算符)
    - [8. 调用构造器](/JavaReadingNotes/84ca0064/#8-调用构造器)
    - [9. 变量](/JavaReadingNotes/84ca0064/#9-变量)
    - [10. 自定义函数](/JavaReadingNotes/84ca0064/#10-自定义函数)
    - [11. Elvis运算符](/JavaReadingNotes/84ca0064/#11-Elvis运算符)
    - [12. 安全导航操作](/JavaReadingNotes/84ca0064/#12-安全导航操作)
    - [13. 集合选择](/JavaReadingNotes/84ca0064/#13-集合选择)
    - [14. 集合投影](/JavaReadingNotes/84ca0064/#14-集合投影)
    - [15. 表达式模板](/JavaReadingNotes/84ca0064/#15-表达式模板)
