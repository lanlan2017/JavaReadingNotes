...
- [7.10.1 获取其他Bean的属性值](/JavaReadingNotes/63fe807f/#7-10-1-获取其他Bean的属性值)
- [程序示例](/JavaReadingNotes/63fe807f/#程序示例)
    - [项目结构](/JavaReadingNotes/63fe807f/#项目结构)
    - [beans.xml](/JavaReadingNotes/63fe807f/#beans-xml)
    - [SpringTest.java](/JavaReadingNotes/63fe807f/#SpringTest-java)
    - [PropertyPathFactoryBean的工厂Bean的id属性是属性表达式的值](/JavaReadingNotes/63fe807f/#PropertyPathFactoryBean的工厂Bean的id属性是属性表达式的值)
    - [使用复合形式设置getter方法](/JavaReadingNotes/63fe807f/#使用复合形式设置getter方法)
    - [以嵌套的Bean实例作为目标Bean](/JavaReadingNotes/63fe807f/#以嵌套的Bean实例作为目标Bean)
    - [util:property-path元素](/JavaReadingNotes/63fe807f/#util-property-path元素)
