...
- [7.2.2 使用Spring管理Bean](/JavaReadingNotes/4033340f/#7-2-2-使用Spring管理Bean)
- [程序示例](/JavaReadingNotes/4033340f/#程序示例)
    - [项目结构](/JavaReadingNotes/4033340f/#项目结构)
    - [Axe.java](/JavaReadingNotes/4033340f/#Axe-java)
        - [什么是依赖](/JavaReadingNotes/4033340f/#什么是依赖)
    - [Person.java](/JavaReadingNotes/4033340f/#Person-java)
    - [Spring如何管理Bean](/JavaReadingNotes/4033340f/#Spring如何管理Bean)
    - [beans.xml](/JavaReadingNotes/4033340f/#beans-xml)
        - [<bean>元素说明](/JavaReadingNotes/4033340f/#<bean>元素说明)
        - [<property>元素说明](/JavaReadingNotes/4033340f/#<property>元素说明)
    - [使用ApplicationContext接口创建Spring容器](/JavaReadingNotes/4033340f/#使用ApplicationContext接口创建Spring容器)
    - [使用getBean方法从Spring容器获取Bean](/JavaReadingNotes/4033340f/#使用getBean方法从Spring容器获取Bean)
    - [使用Spring不用自己创建对象](/JavaReadingNotes/4033340f/#使用Spring不用自己创建对象)
