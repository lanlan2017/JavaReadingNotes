...
- [7.7.2 使用静态工厂方法创建Bean](/JavaReadingNotes/448f9978/#7-7-2-使用静态工厂方法创建Bean)
- [程序示例](/JavaReadingNotes/448f9978/#程序示例)
    - [项目结构](/JavaReadingNotes/448f9978/#项目结构)
    - [Cat.java](/JavaReadingNotes/448f9978/#Cat-java)
    - [Dog.java](/JavaReadingNotes/448f9978/#Dog-java)
    - [BeingFactory.java](/JavaReadingNotes/448f9978/#BeingFactory-java)
    - [beans.xml](/JavaReadingNotes/448f9978/#beans-xml)
    - [SpringTest.java](/JavaReadingNotes/448f9978/#SpringTest-java)
    - [使用静态工厂方法创建实例时对配置文件的要求](/JavaReadingNotes/448f9978/#使用静态工厂方法创建实例时对配置文件的要求)
