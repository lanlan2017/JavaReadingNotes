...
- [7.7 创建Bean的3种方式](/JavaReadingNotes/ac12660e/#7-7-创建Bean的3种方式)
- [7.7.1 使用构造器创建Bean实例](/JavaReadingNotes/ac12660e/#7-7-1-使用构造器创建Bean实例)
    - [采用设值注入时](/JavaReadingNotes/ac12660e/#采用设值注入时)
    - [采用构造注入时](/JavaReadingNotes/ac12660e/#采用构造注入时)
