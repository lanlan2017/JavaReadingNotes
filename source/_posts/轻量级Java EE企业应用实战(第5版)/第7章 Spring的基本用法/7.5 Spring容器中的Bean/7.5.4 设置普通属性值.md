...
- [7.5.4 设置普通属性值](/JavaReadingNotes/c1d6a8b5/#7-5-4-设置普通属性值)
    - [使用<property>元素的value属性](/JavaReadingNotes/c1d6a8b5/#使用<property>元素的value属性)
    - [程序示例](/JavaReadingNotes/c1d6a8b5/#程序示例)
        - [项目结构](/JavaReadingNotes/c1d6a8b5/#项目结构)
        - [ExampleBean.java](/JavaReadingNotes/c1d6a8b5/#ExampleBean-java)
        - [beans.xml](/JavaReadingNotes/c1d6a8b5/#beans-xml)
        - [BeanTest.java](/JavaReadingNotes/c1d6a8b5/#BeanTest-java)
    - [使用<property>元素的<value>子元素](/JavaReadingNotes/c1d6a8b5/#使用<property>元素的<value>子元素)
