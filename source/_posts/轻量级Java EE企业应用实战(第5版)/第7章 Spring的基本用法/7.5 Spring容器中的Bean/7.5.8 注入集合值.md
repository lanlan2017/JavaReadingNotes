...
- [7.5.8 注入集合值](/JavaReadingNotes/3cf6e267/#7-5-8-注入集合值)
    - [项目结构](/JavaReadingNotes/3cf6e267/#项目结构)
    - [Chinese.java](/JavaReadingNotes/3cf6e267/#Chinese-java)
        - [props元素说明](/JavaReadingNotes/3cf6e267/#props元素说明)
        - [map元素说明](/JavaReadingNotes/3cf6e267/#map元素说明)
    - [集合的合并](/JavaReadingNotes/3cf6e267/#集合的合并)
    - [泛型支持](/JavaReadingNotes/3cf6e267/#泛型支持)
