...
- [7.5.2 容器中Bean的作用域](/JavaReadingNotes/dcd14c65/#7-5-2-容器中Bean的作用域)
    - [通过scope属性执行Bean的作用域](/JavaReadingNotes/dcd14c65/#通过scope属性执行Bean的作用域)
    - [程序示例](/JavaReadingNotes/dcd14c65/#程序示例)
    - [beans.xml](/JavaReadingNotes/dcd14c65/#beans-xml)
    - [BeanTest.java](/JavaReadingNotes/dcd14c65/#BeanTest-java)
    - [通过singleton属性指定Bean的作用域](/JavaReadingNotes/dcd14c65/#通过singleton属性指定Bean的作用域)
    - [request和session作用域](/JavaReadingNotes/dcd14c65/#request和session作用域)
    - [如何使得request作用域生效](/JavaReadingNotes/dcd14c65/#如何使得request作用域生效)
    - [程序示例2](/JavaReadingNotes/dcd14c65/#程序示例2)
    - [Spring MVC默认支持request作用域](/JavaReadingNotes/dcd14c65/#Spring-MVC默认支持request作用域)
    - [test.jsp](/JavaReadingNotes/dcd14c65/#test-jsp)
