...
- [7.5.6 使用自动装配注入合作者Bean](/JavaReadingNotes/9eaa638/#7-5-6-使用自动装配注入合作者Bean)
    - [Spring的自动装配](/JavaReadingNotes/9eaa638/#Spring的自动装配)
    - [autowire属性值](/JavaReadingNotes/9eaa638/#autowire属性值)
- [7.5.6.1 byName规则](/JavaReadingNotes/9eaa638/#7-5-6-1-byName规则)
    - [程序示例](/JavaReadingNotes/9eaa638/#程序示例)
        - [项目结构](/JavaReadingNotes/9eaa638/#项目结构)
        - [beans.xml](/JavaReadingNotes/9eaa638/#beans-xml)
        - [Chinese.java](/JavaReadingNotes/9eaa638/#Chinese-java)
- [7.5.6.2 byType规则](/JavaReadingNotes/9eaa638/#7-5-6-2-byType规则)
    - [程序示例](/JavaReadingNotes/9eaa638/#程序示例)
        - [项目结构](/JavaReadingNotes/9eaa638/#项目结构)
        - [beans.xml](/JavaReadingNotes/9eaa638/#beans-xml)
        - [只有一个类型的Bean对象的情况](/JavaReadingNotes/9eaa638/#只有一个类型的Bean对象的情况)
        - [有两个同类型的Bean对象的情况](/JavaReadingNotes/9eaa638/#有两个同类型的Bean对象的情况)
    - [同时指定自动装配和使用ref显示指定依赖时](/JavaReadingNotes/9eaa638/#同时指定自动装配和使用ref显示指定依赖时)
    - [将某些Bean排除在自动装配之外](/JavaReadingNotes/9eaa638/#将某些Bean排除在自动装配之外)
