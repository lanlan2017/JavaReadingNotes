...
- [7.8.2 Bean继承与Java继承的区别](/JavaReadingNotes/7cb04d44/#7-8-2-Bean继承与Java继承的区别)
    - [Spring中的Bean继承和Java中的继承的不同之处](/JavaReadingNotes/7cb04d44/#Spring中的Bean继承和Java中的继承的不同之处)
    - [Spring中的Bean继承和java中的类继承的区别](/JavaReadingNotes/7cb04d44/#Spring中的Bean继承和java中的类继承的区别)
