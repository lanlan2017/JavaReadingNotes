...
- [8.4.5 基于注解的 零配置 方式 8. 定义切入点](/JavaReadingNotes/669c9566/#8-4-5-基于注解的-零配置-方式-8-定义切入点)
    - [定义切入点](/JavaReadingNotes/669c9566/#定义切入点)
    - [切入点语法格式](/JavaReadingNotes/669c9566/#切入点语法格式)
    - [引入当前切面类中的切入点](/JavaReadingNotes/669c9566/#引入当前切面类中的切入点)
    - [引入其他切面类中的切入点](/JavaReadingNotes/669c9566/#引入其他切面类中的切入点)
