...
- [8.1.5 重写占位符配置器](/JavaReadingNotes/ba66180b/#8-1-5-重写占位符配置器)
    - [程序示例](/JavaReadingNotes/ba66180b/#程序示例)
    - [beans.xml](/JavaReadingNotes/ba66180b/#beans-xml)
    - [使用context:property-override元素简化配置](/JavaReadingNotes/ba66180b/#使用context-property-override元素简化配置)
