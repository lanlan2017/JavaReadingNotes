...
- [8.1 两种后处理器](/JavaReadingNotes/c28556ac/#8-1-两种后处理器)
- [8.1.1 Bean后处理器](/JavaReadingNotes/c28556ac/#8-1-1-Bean后处理器)
- [程序示例](/JavaReadingNotes/c28556ac/#程序示例)
    - [ApplicationContext作为Spring容器时会自动注册Bean后处理器](/JavaReadingNotes/c28556ac/#ApplicationContext作为Spring容器时会自动注册Bean后处理器)
    - [BeanFactory作为Spring容器时必须手动注册Bean](/JavaReadingNotes/c28556ac/#BeanFactory作为Spring容器时必须手动注册Bean)
