...
- [8.5.2 使用@Cacheable执行缓存](/JavaReadingNotes/513c6a7a/#8-5-2-使用-Cacheable执行缓存)
- [1. 类级别的缓存](/JavaReadingNotes/513c6a7a/#1-类级别的缓存)
    - [程序示例](/JavaReadingNotes/513c6a7a/#程序示例)
    - [类级别缓存默认以方法的参数作为key来缓存方法返回的数据](/JavaReadingNotes/513c6a7a/#类级别缓存默认以方法的参数作为key来缓存方法返回的数据)
    - [@Cacheable注解的属性](/JavaReadingNotes/513c6a7a/#-Cacheable注解的属性)
    - [@CachePut注解](/JavaReadingNotes/513c6a7a/#-CachePut注解)
    - [@Cacheable的key属性详解](/JavaReadingNotes/513c6a7a/#-Cacheable的key属性详解)
        - [程序示例](/JavaReadingNotes/513c6a7a/#程序示例)
    - [@Cacheable注解的condition属性unless属性详解](/JavaReadingNotes/513c6a7a/#-Cacheable注解的condition属性unless属性详解)
        - [程序示例](/JavaReadingNotes/513c6a7a/#程序示例)
- [2. 方法级别的缓存](/JavaReadingNotes/513c6a7a/#2-方法级别的缓存)
