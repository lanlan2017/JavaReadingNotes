...
- [8.3.4 在ApplicationContext中使用资源](/JavaReadingNotes/3169bf06/#8-3-4-在ApplicationContext中使用资源)
    - [1. 使用ApplicationContext实现类指定访问策略](/JavaReadingNotes/3169bf06/#1-使用ApplicationContext实现类指定访问策略)
    - [2. 使用前缀指定访问策略](/JavaReadingNotes/3169bf06/#2-使用前缀指定访问策略)
    - [classpath:前缀指定资源访问策略仅仅对当次访问有效](/JavaReadingNotes/3169bf06/#classpath-前缀指定资源访问策略仅仅对当次访问有效)
    - [ApplicationContext访问资源时建议显示采用对应实现类来加载配置文件](/JavaReadingNotes/3169bf06/#ApplicationContext访问资源时建议显示采用对应实现类来加载配置文件)
    - [3. classpath*:前缀的用法](/JavaReadingNotes/3169bf06/#3-classpath*-前缀的用法)
