...
- [8.3.1 Resource实现类](/JavaReadingNotes/cd4ae4ec/#8-3-1-Resource实现类)
- [1. 访问网络资源](/JavaReadingNotes/cd4ae4ec/#1-访问网络资源)
    - [程序示例](/JavaReadingNotes/cd4ae4ec/#程序示例)
- [2. 访问类加载路径下的资源](/JavaReadingNotes/cd4ae4ec/#2-访问类加载路径下的资源)
    - [程序示例](/JavaReadingNotes/cd4ae4ec/#程序示例)
- [3. 访问文件系统资源](/JavaReadingNotes/cd4ae4ec/#3-访问文件系统资源)
    - [程序示例](/JavaReadingNotes/cd4ae4ec/#程序示例)
- [4. 访问应用相关资源](/JavaReadingNotes/cd4ae4ec/#4-访问应用相关资源)
    - [访问Web Context下的资源时使用File类ServletContextResource的区别](/JavaReadingNotes/cd4ae4ec/#访问Web-Context下的资源时使用File类ServletContextResource的区别)
    - [程序示例](/JavaReadingNotes/cd4ae4ec/#程序示例)
- [5. 访问字节数组资源](/JavaReadingNotes/cd4ae4ec/#5-访问字节数组资源)
    - [尽量不要使用InputStreamResource](/JavaReadingNotes/cd4ae4ec/#尽量不要使用InputStreamResource)
    - [程序示例](/JavaReadingNotes/cd4ae4ec/#程序示例)
