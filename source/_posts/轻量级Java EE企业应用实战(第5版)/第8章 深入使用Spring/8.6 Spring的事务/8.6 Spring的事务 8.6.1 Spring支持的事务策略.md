...
- [8.6 Spring的事务](/JavaReadingNotes/a0b1c8e/#8-6-Spring的事务)
- [8.6.1 Spring支持的事务策略](/JavaReadingNotes/a0b1c8e/#8-6-1-Spring支持的事务策略)
    - [PlatformTransactionManager接口](/JavaReadingNotes/a0b1c8e/#PlatformTransactionManager接口)
    - [TransactionDefinition接口](/JavaReadingNotes/a0b1c8e/#TransactionDefinition接口)
    - [TransactionStatus接口](/JavaReadingNotes/a0b1c8e/#TransactionStatus接口)
    - [程序示例](/JavaReadingNotes/a0b1c8e/#程序示例)
        - [JDBC数据源配置示例](/JavaReadingNotes/a0b1c8e/#JDBC数据源配置示例)
        - [JTA配置示例](/JavaReadingNotes/a0b1c8e/#JTA配置示例)
        - [Hibernate配置示例](/JavaReadingNotes/a0b1c8e/#Hibernate配置示例)
