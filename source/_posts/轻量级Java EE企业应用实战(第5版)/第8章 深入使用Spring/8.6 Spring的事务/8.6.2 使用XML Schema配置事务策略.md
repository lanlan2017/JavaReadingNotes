...
- [8.6.2 使用XML Schema配置事务策略](/JavaReadingNotes/3d0dab0e/#8-6-2-使用XML-Schema配置事务策略)
    - [method元素](/JavaReadingNotes/3d0dab0e/#method元素)
        - [method元素的propagation属性值](/JavaReadingNotes/3d0dab0e/#method元素的propagation属性值)
- [程序示例](/JavaReadingNotes/3d0dab0e/#程序示例)
    - [NewsDaoImpl.java](/JavaReadingNotes/3d0dab0e/#NewsDaoImpl-java)
    - [配置文件](/JavaReadingNotes/3d0dab0e/#配置文件)
    - [配置文件详解](/JavaReadingNotes/3d0dab0e/#配置文件详解)
        - [引入命名空间](/JavaReadingNotes/3d0dab0e/#引入命名空间)
        - [配置事务增强处理](/JavaReadingNotes/3d0dab0e/#配置事务增强处理)
        - [确保事务增强处理在合适的切入点被织入](/JavaReadingNotes/3d0dab0e/#确保事务增强处理在合适的切入点被织入)
    - [主程序](/JavaReadingNotes/3d0dab0e/#主程序)
- [事务代理的业务方法](/JavaReadingNotes/3d0dab0e/#事务代理的业务方法)
- [为不同的业务逻辑方法指定不同的事务策略](/JavaReadingNotes/3d0dab0e/#为不同的业务逻辑方法指定不同的事务策略)
- [在遇到特定checked异常时自动回滚](/JavaReadingNotes/3d0dab0e/#在遇到特定checked异常时自动回滚)
- [遇到特定runtime异常时强制不回滚](/JavaReadingNotes/3d0dab0e/#遇到特定runtime异常时强制不回滚)
