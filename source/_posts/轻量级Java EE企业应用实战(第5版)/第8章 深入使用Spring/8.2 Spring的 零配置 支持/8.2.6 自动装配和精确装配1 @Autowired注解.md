...
- [8.2.6 自动装配和精确装配](/JavaReadingNotes/adf82bcd/#8-2-6-自动装配和精确装配)
- [@Autowired注解](/JavaReadingNotes/adf82bcd/#-Autowired注解)
    - [@Autowired修饰setter时](/JavaReadingNotes/adf82bcd/#-Autowired修饰setter时)
    - [@Autowired修饰普通方法时](/JavaReadingNotes/adf82bcd/#-Autowired修饰普通方法时)
    - [@Autowired修饰实例变量时](/JavaReadingNotes/adf82bcd/#-Autowired修饰实例变量时)
    - [@Autowired修饰构造时](/JavaReadingNotes/adf82bcd/#-Autowired修饰构造时)
    - [@Autowired修饰数组类型的成员变量时](/JavaReadingNotes/adf82bcd/#-Autowired修饰数组类型的成员变量时)
    - [@Autowired修饰集合类型的实例变量时](/JavaReadingNotes/adf82bcd/#-Autowired修饰集合类型的实例变量时)
        - [@Autowired修饰集合类型的实例变量时 必须使用泛型](/JavaReadingNotes/adf82bcd/#-Autowired修饰集合类型的实例变量时-必须使用泛型)
    - [@Autowired主机默认使用byType策略来自动装配](/JavaReadingNotes/adf82bcd/#-Autowired主机默认使用byType策略来自动装配)
    - [@Autowired根据泛型进行自动装配](/JavaReadingNotes/adf82bcd/#-Autowired根据泛型进行自动装配)
