...
- [8.2.5 使用@DependsOn和@Lazy改变初始化行为](/JavaReadingNotes/1446d3d6/#8-2-5-使用-DependsOn和-Lazy改变初始化行为)
    - [@DependsOn注解介绍](/JavaReadingNotes/1446d3d6/#-DependsOn注解介绍)
    - [@Lazy注解介绍](/JavaReadingNotes/1446d3d6/#-Lazy注解介绍)
