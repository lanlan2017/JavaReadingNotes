...
- [8.2 Spring的"零配置"支持](/JavaReadingNotes/3a81c2f8/#8-2-Spring的"零配置"支持)
- [8.2.1 搜索Bean类](/JavaReadingNotes/3a81c2f8/#8-2-1-搜索Bean类)
    - [Rails框架的做法](/JavaReadingNotes/3a81c2f8/#Rails框架的做法)
    - [Spring框架的做法](/JavaReadingNotes/3a81c2f8/#Spring框架的做法)
    - [标注Bean类的注解](/JavaReadingNotes/3a81c2f8/#标注Bean类的注解)
    - [使用context Schema指定搜索路径](/JavaReadingNotes/3a81c2f8/#使用context-Schema指定搜索路径)
    - [使用注解方式时将类名首字母变小写得到Bean的名称](/JavaReadingNotes/3a81c2f8/#使用注解方式时将类名首字母变小写得到Bean的名称)
    - [使用注解设置Bean的名称](/JavaReadingNotes/3a81c2f8/#使用注解设置Bean的名称)
    - [@Lookup注解执行方法注入](/JavaReadingNotes/3a81c2f8/#-Lookup注解执行方法注入)
        - [lookup-method元素复习](/JavaReadingNotes/3a81c2f8/#lookup-method元素复习)
        - [@Lookup注解通过value属性指定要注入的Bean的id](/JavaReadingNotes/3a81c2f8/#-Lookup注解通过value属性指定要注入的Bean的id)
    - [扫描bean的时候对bean进行过滤](/JavaReadingNotes/3a81c2f8/#扫描bean的时候对bean进行过滤)
        - [include-filte元素](/JavaReadingNotes/3a81c2f8/#include-filte元素)
- [程序示例](/JavaReadingNotes/3a81c2f8/#程序示例)
    - [beans.xml](/JavaReadingNotes/3a81c2f8/#beans-xml)
