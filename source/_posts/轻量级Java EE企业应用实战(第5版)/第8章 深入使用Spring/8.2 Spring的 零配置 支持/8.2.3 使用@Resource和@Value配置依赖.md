...
- [8.2.3 使用@Resource和@Value配置依赖](/JavaReadingNotes/4535a34/#8-2-3-使用-Resource和-Value配置依赖)
    - [使用@Resource来注入其他Bean](/JavaReadingNotes/4535a34/#使用-Resource来注入其他Bean)
    - [使用@Value来注入直接量](/JavaReadingNotes/4535a34/#使用-Value来注入直接量)
    - [@Resource @Value直接修饰实例变量](/JavaReadingNotes/4535a34/#-Resource-Value直接修饰实例变量)
    - [省略name属性时@Resource注解如何确定要注入哪个Bean](/JavaReadingNotes/4535a34/#省略name属性时-Resource注解如何确定要注入哪个Bean)
        - [使用setter方法名称来确定要注入的Bean](/JavaReadingNotes/4535a34/#使用setter方法名称来确定要注入的Bean)
        - [使用示例变量的名称来确定要注入的Bean](/JavaReadingNotes/4535a34/#使用示例变量的名称来确定要注入的Bean)
