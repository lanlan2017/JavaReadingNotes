...
- [8.2.4 使用@PostConstruct和@PreDestroy定制生命周期行为](/JavaReadingNotes/454c8117/#8-2-4-使用-PostConstruct和-PreDestroy定制生命周期行为)
    - [XML配置如何指定生命周期方法](/JavaReadingNotes/454c8117/#XML配置如何指定生命周期方法)
    - [使用注解如何指定生命周期方法](/JavaReadingNotes/454c8117/#使用注解如何指定生命周期方法)
- [程序示例](/JavaReadingNotes/454c8117/#程序示例)
