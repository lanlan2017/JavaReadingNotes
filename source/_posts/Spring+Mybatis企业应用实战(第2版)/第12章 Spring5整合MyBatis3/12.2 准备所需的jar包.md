...
- [12.2 准备所需的jar包](/JavaReadingNotes/e35901ab/#12-2-准备所需的jar包)
    - [项目结构](/JavaReadingNotes/e35901ab/#项目结构)
    - [Spring框架的jar包](/JavaReadingNotes/e35901ab/#Spring框架的jar包)
    - [MyBatis框架jar包](/JavaReadingNotes/e35901ab/#MyBatis框架jar包)
    - [MyBatis整合Spring中间件jar包](/JavaReadingNotes/e35901ab/#MyBatis整合Spring中间件jar包)
    - [Aspectj框架的jar包](/JavaReadingNotes/e35901ab/#Aspectj框架的jar包)
    - [数据库驱动jar包](/JavaReadingNotes/e35901ab/#数据库驱动jar包)
    - [数据源C3P0所需jar包](/JavaReadingNotes/e35901ab/#数据源C3P0所需jar包)
    - [JSTL标签库jar包](/JavaReadingNotes/e35901ab/#JSTL标签库jar包)
