...
- [6.2.2 Spring支持的转换器 示例 使用InitBinder注解添加自定义编辑器转换数据](/JavaReadingNotes/c48866c4/#6-2-2-Spring支持的转换器-示例-使用InitBinder注解添加自定义编辑器转换数据)
    - [域对象](/JavaReadingNotes/c48866c4/#域对象)
    - [测试链接](/JavaReadingNotes/c48866c4/#测试链接)
    - [请求处理方法](/JavaReadingNotes/c48866c4/#请求处理方法)
    - [表单](/JavaReadingNotes/c48866c4/#表单)
    - [填写表单并提交](/JavaReadingNotes/c48866c4/#填写表单并提交)
    - [表单处理方法](/JavaReadingNotes/c48866c4/#表单处理方法)
        - [自定义属性编辑器](/JavaReadingNotes/c48866c4/#自定义属性编辑器)
    - [显示效果](/JavaReadingNotes/c48866c4/#显示效果)
