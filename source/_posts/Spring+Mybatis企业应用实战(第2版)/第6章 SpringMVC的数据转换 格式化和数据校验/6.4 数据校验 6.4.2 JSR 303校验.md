...
- [6.4 数据校验 6.4.2 JSR 303校验](/JavaReadingNotes/9d26e814/#6-4-数据校验-6-4-2-JSR-303校验)
    - [下载JSR 303](/JavaReadingNotes/9d26e814/#下载JSR-303)
    - [JSR 303注解](/JavaReadingNotes/9d26e814/#JSR-303注解)
    - [Hibernate Validator扩展注解](/JavaReadingNotes/9d26e814/#Hibernate-Validator扩展注解)
- [示例 测试JSR 303校验](/JavaReadingNotes/9d26e814/#示例-测试JSR-303校验)
    - [registerForm.jsp](/JavaReadingNotes/9d26e814/#registerForm-jsp)
    - [User.java](/JavaReadingNotes/9d26e814/#User-java)
    - [UserController.java](/JavaReadingNotes/9d26e814/#UserController-java)
    - [success.jsp](/JavaReadingNotes/9d26e814/#success-jsp)
    - [国际化错误提示信息](/JavaReadingNotes/9d26e814/#国际化错误提示信息)
        - [错误消息代码](/JavaReadingNotes/9d26e814/#错误消息代码)
    - [message_en_US.properties](/JavaReadingNotes/9d26e814/#message-en-US-properties)
    - [message_zh_CN.properties](/JavaReadingNotes/9d26e814/#message-zh-CN-properties)
    - [springmvc-config.xml](/JavaReadingNotes/9d26e814/#springmvc-config-xml)
    - [测试](/JavaReadingNotes/9d26e814/#测试)
        - [乱填表单](/JavaReadingNotes/9d26e814/#乱填表单)
        - [错误提示](/JavaReadingNotes/9d26e814/#错误提示)
