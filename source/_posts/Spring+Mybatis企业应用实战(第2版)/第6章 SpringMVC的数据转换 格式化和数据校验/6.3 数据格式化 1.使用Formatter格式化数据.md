...
- [6.3 数据格式化](/JavaReadingNotes/c135e2b/#6-3-数据格式化)
    - [Converter和Formatter的区别](/JavaReadingNotes/c135e2b/#Converter和Formatter的区别)
- [Spring MVC格式化接口](/JavaReadingNotes/c135e2b/#Spring-MVC格式化接口)
    - [Printer接口](/JavaReadingNotes/c135e2b/#Printer接口)
    - [Parser接口](/JavaReadingNotes/c135e2b/#Parser接口)
    - [Formatter接口](/JavaReadingNotes/c135e2b/#Formatter接口)
    - [FormatterRegistrar接口](/JavaReadingNotes/c135e2b/#FormatterRegistrar接口)
    - [AnnotationFormatterFactory接口](/JavaReadingNotes/c135e2b/#AnnotationFormatterFactory接口)
- [示例 使用Formatter格式化数据](/JavaReadingNotes/c135e2b/#示例-使用Formatter格式化数据)
    - [使用自定义的格式化类](/JavaReadingNotes/c135e2b/#使用自定义的格式化类)
        - [DateFormatter](/JavaReadingNotes/c135e2b/#DateFormatter)
        - [springmvc-config.xml](/JavaReadingNotes/c135e2b/#springmvc-config-xml)
        - [User.java](/JavaReadingNotes/c135e2b/#User-java)
        - [UserController.java](/JavaReadingNotes/c135e2b/#UserController-java)
        - [registerForm.jsp](/JavaReadingNotes/c135e2b/#registerForm-jsp)
        - [success.jsp](/JavaReadingNotes/c135e2b/#success-jsp)
        - [测试](/JavaReadingNotes/c135e2b/#测试)
    - [使用Spring提供的格式化类](/JavaReadingNotes/c135e2b/#使用Spring提供的格式化类)
