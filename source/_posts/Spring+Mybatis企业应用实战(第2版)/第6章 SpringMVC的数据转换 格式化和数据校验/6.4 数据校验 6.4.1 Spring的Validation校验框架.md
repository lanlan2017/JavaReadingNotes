...
- [6.4 数据校验](/JavaReadingNotes/6e2018b3/#6-4-数据校验)
    - [输入校验](/JavaReadingNotes/6e2018b3/#输入校验)
- [6.4.1 Spring的Validation校验框架](/JavaReadingNotes/6e2018b3/#6-4-1-Spring的Validation校验框架)
    - [Validator接口](/JavaReadingNotes/6e2018b3/#Validator接口)
    - [Errors接口](/JavaReadingNotes/6e2018b3/#Errors接口)
    - [ValidationUtils工具类](/JavaReadingNotes/6e2018b3/#ValidationUtils工具类)
    - [LocalValidatorFactoryBean类](/JavaReadingNotes/6e2018b3/#LocalValidatorFactoryBean类)
- [实例 表单输入校验](/JavaReadingNotes/6e2018b3/#实例-表单输入校验)
    - [loginForm.jsp](/JavaReadingNotes/6e2018b3/#loginForm-jsp)
    - [User.java](/JavaReadingNotes/6e2018b3/#User-java)
    - [UserValidator.java](/JavaReadingNotes/6e2018b3/#UserValidator-java)
    - [UserController.java](/JavaReadingNotes/6e2018b3/#UserController-java)
    - [测试](/JavaReadingNotes/6e2018b3/#测试)
        - [错误填写](/JavaReadingNotes/6e2018b3/#错误填写)
        - [显示效果](/JavaReadingNotes/6e2018b3/#显示效果)
    - [最后说一句](/JavaReadingNotes/6e2018b3/#最后说一句)
