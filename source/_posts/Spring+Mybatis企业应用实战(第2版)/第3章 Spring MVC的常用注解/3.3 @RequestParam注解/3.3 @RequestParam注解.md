...
- [3.3 @RequestParam注解](/JavaReadingNotes/b672b7a5/#3-3-RequestParam注解)
- [示例 @RequestMapping和@RequestParam注解的使用](/JavaReadingNotes/b672b7a5/#示例-RequestMapping和-RequestParam注解的使用)
    - [User.java](/JavaReadingNotes/b672b7a5/#User-java)
    - [UserController.java](/JavaReadingNotes/b672b7a5/#UserController-java)
    - [registerForm.jsp](/JavaReadingNotes/b672b7a5/#registerForm-jsp)
    - [loginForm.jsp](/JavaReadingNotes/b672b7a5/#loginForm-jsp)
    - [welcome.jsp](/JavaReadingNotes/b672b7a5/#welcome-jsp)
    - [测试](/JavaReadingNotes/b672b7a5/#测试)
