...
- [3.12 @ModelAttribute注解](/JavaReadingNotes/d2cd4a56/#3-12-ModelAttribute注解)
- [示例 @ModelAttribute注解的使用](/JavaReadingNotes/d2cd4a56/#示例-ModelAttribute注解的使用)
    - [index.jsp](/JavaReadingNotes/d2cd4a56/#index-jsp)
    - [FormController.java](/JavaReadingNotes/d2cd4a56/#FormController-java)
    - [1.测试@ModelAttribute(value="")注释返回具体类的方法](/JavaReadingNotes/d2cd4a56/#1-测试-ModelAttribute-value=""-注释返回具体类的方法)
        - [loginForm1.jsp](/JavaReadingNotes/d2cd4a56/#loginForm1-jsp)
        - [ModelAttribute1Controller.java](/JavaReadingNotes/d2cd4a56/#ModelAttribute1Controller-java)
        - [result1.jsp](/JavaReadingNotes/d2cd4a56/#result1-jsp)
- [2.测试@ModelAttribute注释void返回值的方法](/JavaReadingNotes/d2cd4a56/#2-测试-ModelAttribute注释void返回值的方法)
    - [loginForm2.jsp](/JavaReadingNotes/d2cd4a56/#loginForm2-jsp)
    - [ModelAttribute2Controller.java](/JavaReadingNotes/d2cd4a56/#ModelAttribute2Controller-java)
    - [result2.jsp](/JavaReadingNotes/d2cd4a56/#result2-jsp)
- [3.测试@ModelAttribute注释返回具体类的方法](/JavaReadingNotes/d2cd4a56/#3-测试-ModelAttribute注释返回具体类的方法)
    - [ModelAttribute3Controller.java](/JavaReadingNotes/d2cd4a56/#ModelAttribute3Controller-java)
    - [result3.jsp](/JavaReadingNotes/d2cd4a56/#result3-jsp)
- [4 测试ModelAttribute和@RequestMapping同时注释一个方法](/JavaReadingNotes/d2cd4a56/#4-测试ModelAttribute和-RequestMapping同时注释一个方法)
    - [ModelAttribute4Controller.java](/JavaReadingNotes/d2cd4a56/#ModelAttribute4Controller-java)
    - [login4.jsp](/JavaReadingNotes/d2cd4a56/#login4-jsp)
- [5 测试@ModelAttribute注释一个方法的参数](/JavaReadingNotes/d2cd4a56/#5-测试-ModelAttribute注释一个方法的参数)
    - [ModelAttribute5Controller.java](/JavaReadingNotes/d2cd4a56/#ModelAttribute5Controller-java)
    - [result5.jsp](/JavaReadingNotes/d2cd4a56/#result5-jsp)
