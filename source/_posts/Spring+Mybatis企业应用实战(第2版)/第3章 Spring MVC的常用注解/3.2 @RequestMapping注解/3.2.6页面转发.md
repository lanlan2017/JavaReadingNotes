...
- [3.2.6 页面转发](/JavaReadingNotes/af8b0d33/#3-2-6-页面转发)
    - [1. 转发到JSP页面](/JavaReadingNotes/af8b0d33/#1-转发到JSP页面)
        - [请求处理方法返回值是字符串的情况](/JavaReadingNotes/af8b0d33/#请求处理方法返回值是字符串的情况)
        - [请求处理方法返回值是ModelAndView的情况](/JavaReadingNotes/af8b0d33/#请求处理方法返回值是ModelAndView的情况)
        - [客户端重定向和服务器内部跳转的区别](/JavaReadingNotes/af8b0d33/#客户端重定向和服务器内部跳转的区别)
    - [2. 转发到控制器的请求处理方法](/JavaReadingNotes/af8b0d33/#2-转发到控制器的请求处理方法)
        - [请求处理方法的返回值是字符串的情况](/JavaReadingNotes/af8b0d33/#请求处理方法的返回值是字符串的情况)
        - [请求处理方法的返回值是ModelAndView对象时](/JavaReadingNotes/af8b0d33/#请求处理方法的返回值是ModelAndView对象时)
