...
- [3.1 @Controller注解](/JavaReadingNotes/a4fd15ac/#3-1-Controller注解)
- [示例: @Controller注解的使用](/JavaReadingNotes/a4fd15ac/#示例-Controller注解的使用)
    - [HelloWorldController](/JavaReadingNotes/a4fd15ac/#HelloWorldController)
    - [springmvc-config.xml](/JavaReadingNotes/a4fd15ac/#springmvc-config-xml)
    - [映射URL和控制器](/JavaReadingNotes/a4fd15ac/#映射URL和控制器)
    - [使用默认装配方案](/JavaReadingNotes/a4fd15ac/#使用默认装配方案)
    - [静态资源处理器](/JavaReadingNotes/a4fd15ac/#静态资源处理器)
    - [视图解析器](/JavaReadingNotes/a4fd15ac/#视图解析器)
    - [使用默认的处理器映射器和处理器适配器](/JavaReadingNotes/a4fd15ac/#使用默认的处理器映射器和处理器适配器)
    - [测试](/JavaReadingNotes/a4fd15ac/#测试)
- [用于参数绑定的注解](/JavaReadingNotes/a4fd15ac/#用于参数绑定的注解)
    - [处理请求参数和内容部分的注解](/JavaReadingNotes/a4fd15ac/#处理请求参数和内容部分的注解)
    - [处理请求URL部分的注解](/JavaReadingNotes/a4fd15ac/#处理请求URL部分的注解)
    - [处理请求头部分的注解](/JavaReadingNotes/a4fd15ac/#处理请求头部分的注解)
    - [处理属性类型的注解](/JavaReadingNotes/a4fd15ac/#处理属性类型的注解)
    - [处理异常类型的注解](/JavaReadingNotes/a4fd15ac/#处理异常类型的注解)
    - [绑定表单数据的注解](/JavaReadingNotes/a4fd15ac/#绑定表单数据的注解)
