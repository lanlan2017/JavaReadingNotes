...
- [9.4.5 ResultMaps](/JavaReadingNotes/d63c6e62/#9-4-5-ResultMaps)
    - [每条记录转换成一个Map](/JavaReadingNotes/d63c6e62/#每条记录转换成一个Map)
- [示例: 测试ResultMaps](/JavaReadingNotes/d63c6e62/#示例-测试ResultMaps)
    - [简单映射 一条记录封装成map](/JavaReadingNotes/d63c6e62/#简单映射-一条记录封装成map)
        - [SelectMapTest.java](/JavaReadingNotes/d63c6e62/#SelectMapTest-java)
        - [对应的select标签](/JavaReadingNotes/d63c6e62/#对应的select标签)
        - [数据库表](/JavaReadingNotes/d63c6e62/#数据库表)
        - [运行结果](/JavaReadingNotes/d63c6e62/#运行结果)
    - [简单映射 每条记录封装成一个持久化对象](/JavaReadingNotes/d63c6e62/#简单映射-每条记录封装成一个持久化对象)
    - [ResultMap标签](/JavaReadingNotes/d63c6e62/#ResultMap标签)
        - [数据表列名和持久化对象属性名不一致的情况](/JavaReadingNotes/d63c6e62/#数据表列名和持久化对象属性名不一致的情况)
            - [resultMap标签详解](/JavaReadingNotes/d63c6e62/#resultMap标签详解)
                - [resultMap标签详解](/JavaReadingNotes/d63c6e62/#resultMap标签详解)
                    - [resultMap标签的id子标签](/JavaReadingNotes/d63c6e62/#resultMap标签的id子标签)
                    - [resultMap标签的result子标签](/JavaReadingNotes/d63c6e62/#resultMap标签的result子标签)
    - [关联映射](/JavaReadingNotes/d63c6e62/#关联映射)
        - [Clazz.java](/JavaReadingNotes/d63c6e62/#Clazz-java)
        - [Student.java](/JavaReadingNotes/d63c6e62/#Student-java)
        - [映射配置](/JavaReadingNotes/d63c6e62/#映射配置)
        - [SelectStudentTest.java](/JavaReadingNotes/d63c6e62/#SelectStudentTest-java)
        - [运行结果](/JavaReadingNotes/d63c6e62/#运行结果)
    - [集合映射](/JavaReadingNotes/d63c6e62/#集合映射)
        - [映射配置](/JavaReadingNotes/d63c6e62/#映射配置)
        - [collection标签详解](/JavaReadingNotes/d63c6e62/#collection标签详解)
        - [SelectClazzTest.java](/JavaReadingNotes/d63c6e62/#SelectClazzTest-java)
