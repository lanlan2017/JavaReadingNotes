...
- [9.4 深入Mapper XML映射文件 示例 测试select,insert,update和delete操作](/JavaReadingNotes/741976a5/#9-4-深入Mapper-XML映射文件-示例-测试select,insert,update和delete操作)
    - [db.properties](/JavaReadingNotes/741976a5/#db-properties)
    - [mybatis-config.xml](/JavaReadingNotes/741976a5/#mybatis-config-xml)
        - [引入properties配置文件](/JavaReadingNotes/741976a5/#引入properties配置文件)
        - [引用properties配置文件中的值](/JavaReadingNotes/741976a5/#引用properties配置文件中的值)
    - [UserMapper.xml](/JavaReadingNotes/741976a5/#UserMapper-xml)
    - [FKSqlSessionFactory](/JavaReadingNotes/741976a5/#FKSqlSessionFactory)
    - [测试](/JavaReadingNotes/741976a5/#测试)
        - [测试insert](/JavaReadingNotes/741976a5/#测试insert)
        - [测试select标签](/JavaReadingNotes/741976a5/#测试select标签)
        - [测试update元素](/JavaReadingNotes/741976a5/#测试update元素)
        - [测试delete元素](/JavaReadingNotes/741976a5/#测试delete元素)
