...
- [7.1 文件上传](/JavaReadingNotes/4b83a5b7/#7-1-文件上传)
    - [示例 Spring MVC的文件上传](/JavaReadingNotes/4b83a5b7/#示例-Spring-MVC的文件上传)
        - [Spring配置文件中添加配置](/JavaReadingNotes/4b83a5b7/#Spring配置文件中添加配置)
        - [引入CommonsFileUpload的jar包](/JavaReadingNotes/4b83a5b7/#引入CommonsFileUpload的jar包)
        - [MultipartFile对象](/JavaReadingNotes/4b83a5b7/#MultipartFile对象)
        - [error.jsp](/JavaReadingNotes/4b83a5b7/#error-jsp)
        - [success.jsp](/JavaReadingNotes/4b83a5b7/#success-jsp)
        - [uploadForm.jsp](/JavaReadingNotes/4b83a5b7/#uploadForm-jsp)
        - [测试链接](/JavaReadingNotes/4b83a5b7/#测试链接)
        - [上传文件](/JavaReadingNotes/4b83a5b7/#上传文件)
        - [上传效果](/JavaReadingNotes/4b83a5b7/#上传效果)
        - [控制台输出](/JavaReadingNotes/4b83a5b7/#控制台输出)
    - [示例 使用对象接收上传文件](/JavaReadingNotes/4b83a5b7/#示例-使用对象接收上传文件)
        - [域对象](/JavaReadingNotes/4b83a5b7/#域对象)
        - [测试链接](/JavaReadingNotes/4b83a5b7/#测试链接)
        - [请求处理方法](/JavaReadingNotes/4b83a5b7/#请求处理方法)
        - [registerForm.jsp](/JavaReadingNotes/4b83a5b7/#registerForm-jsp)
        - [设置用户名和头像](/JavaReadingNotes/4b83a5b7/#设置用户名和头像)
        - [注册请求处理方法](/JavaReadingNotes/4b83a5b7/#注册请求处理方法)
        - [userInfo.jsp](/JavaReadingNotes/4b83a5b7/#userInfo-jsp)
    - [示例 SpringMVC的文件下载](/JavaReadingNotes/4b83a5b7/#示例-SpringMVC的文件下载)
        - [download请求处理方法](/JavaReadingNotes/4b83a5b7/#download请求处理方法)
        - [下载效果](/JavaReadingNotes/4b83a5b7/#下载效果)
