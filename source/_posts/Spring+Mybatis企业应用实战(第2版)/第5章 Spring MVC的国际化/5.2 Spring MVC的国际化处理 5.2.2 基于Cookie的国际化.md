...
- [5.2 Spring MVC的国际化处理 5.2.2 基于Cookie的国际化实现](/JavaReadingNotes/cdc560cf/#5-2-Spring-MVC的国际化处理-5-2-2-基于Cookie的国际化实现)
- [实例 基于Cookie的国际化实现](/JavaReadingNotes/cdc560cf/#实例-基于Cookie的国际化实现)
    - [springmvc-config.xml](/JavaReadingNotes/cdc560cf/#springmvc-config-xml)
        - [加载国际化资源文件](/JavaReadingNotes/cdc560cf/#加载国际化资源文件)
        - [国际化拦截器](/JavaReadingNotes/cdc560cf/#国际化拦截器)
        - [创建CookieLocaleResolver](/JavaReadingNotes/cdc560cf/#创建CookieLocaleResolver)
    - [UserController.java](/JavaReadingNotes/cdc560cf/#UserController-java)
    - [loginForm.jsp](/JavaReadingNotes/cdc560cf/#loginForm-jsp)
    - [success.jsp](/JavaReadingNotes/cdc560cf/#success-jsp)
    - [测试](/JavaReadingNotes/cdc560cf/#测试)
        - [默认](/JavaReadingNotes/cdc560cf/#默认)
        - [中文环境](/JavaReadingNotes/cdc560cf/#中文环境)
