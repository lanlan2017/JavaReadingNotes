...
- [5.2 Spring MVC的国际化处理](/JavaReadingNotes/85d4b26/#5-2-Spring-MVC的国际化处理)
    - [5.2.1 AcceptHeaderLocaleResolver](/JavaReadingNotes/85d4b26/#5-2-1-AcceptHeaderLocaleResolver)
    - [示例:基于浏览器请求的国际化实现](/JavaReadingNotes/85d4b26/#示例-基于浏览器请求的国际化实现)
        - [message_enUs.properties](/JavaReadingNotes/85d4b26/#message-enUs-properties)
        - [message_zh_CN.properties](/JavaReadingNotes/85d4b26/#message-zh-CN-properties)
    - [loginForm.jsp](/JavaReadingNotes/85d4b26/#loginForm-jsp)
    - [springmvc-config.xml](/JavaReadingNotes/85d4b26/#springmvc-config-xml)
        - [国际化配置](/JavaReadingNotes/85d4b26/#国际化配置)
    - [UserController.java](/JavaReadingNotes/85d4b26/#UserController-java)
    - [success.jsp](/JavaReadingNotes/85d4b26/#success-jsp)
    - [测试](/JavaReadingNotes/85d4b26/#测试)
    - [测试国际化](/JavaReadingNotes/85d4b26/#测试国际化)
        - [设置浏览器语言](/JavaReadingNotes/85d4b26/#设置浏览器语言)
        - [显示效果](/JavaReadingNotes/85d4b26/#显示效果)
