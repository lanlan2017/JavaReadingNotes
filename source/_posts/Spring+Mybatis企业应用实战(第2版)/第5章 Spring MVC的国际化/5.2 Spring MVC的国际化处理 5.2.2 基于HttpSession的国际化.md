...
- [5.2 Spring MVC的国际化处理 5.2.2 基于 Httpsession的国际化](/JavaReadingNotes/dff20a30/#5-2-Spring-MVC的国际化处理-5-2-2-基于-Httpsession的国际化)
    - [SessionLocaleResolver](/JavaReadingNotes/dff20a30/#SessionLocaleResolver)
    - [实例 基于Httpsession的国际化实现](/JavaReadingNotes/dff20a30/#实例-基于Httpsession的国际化实现)
        - [loginForm.jsp](/JavaReadingNotes/dff20a30/#loginForm-jsp)
        - [springmvc-config.xml](/JavaReadingNotes/dff20a30/#springmvc-config-xml)
    - [UserController.java](/JavaReadingNotes/dff20a30/#UserController-java)
    - [测试](/JavaReadingNotes/dff20a30/#测试)
        - [切换中文环境](/JavaReadingNotes/dff20a30/#切换中文环境)
        - [切换英文环境](/JavaReadingNotes/dff20a30/#切换英文环境)
