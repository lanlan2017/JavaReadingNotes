...
- [4.1.10 select标签](/JavaReadingNotes/1482d2ca/#4-1-10-select标签)
    - [领域对象](/JavaReadingNotes/1482d2ca/#领域对象)
        - [User.java](/JavaReadingNotes/1482d2ca/#User-java)
        - [Dept](/JavaReadingNotes/1482d2ca/#Dept)
    - [select option标签](/JavaReadingNotes/1482d2ca/#select-option标签)
        - [测试链接](/JavaReadingNotes/1482d2ca/#测试链接)
        - [请求处理方法](/JavaReadingNotes/1482d2ca/#请求处理方法)
        - [表单标签](/JavaReadingNotes/1482d2ca/#表单标签)
        - [渲染效果](/JavaReadingNotes/1482d2ca/#渲染效果)
        - [显示效果](/JavaReadingNotes/1482d2ca/#显示效果)
    - [select标签 map作为数据源](/JavaReadingNotes/1482d2ca/#select标签-map作为数据源)
        - [测试链接](/JavaReadingNotes/1482d2ca/#测试链接)
        - [请求处理方法](/JavaReadingNotes/1482d2ca/#请求处理方法)
        - [表单标签库](/JavaReadingNotes/1482d2ca/#表单标签库)
        - [渲染结果](/JavaReadingNotes/1482d2ca/#渲染结果)
        - [显示效果](/JavaReadingNotes/1482d2ca/#显示效果)
- [options标签](/JavaReadingNotes/1482d2ca/#options标签)
    - [select option标签 map数据源](/JavaReadingNotes/1482d2ca/#select-option标签-map数据源)
        - [测试链接](/JavaReadingNotes/1482d2ca/#测试链接)
        - [请求处理方法](/JavaReadingNotes/1482d2ca/#请求处理方法)
        - [表单标签数据绑定](/JavaReadingNotes/1482d2ca/#表单标签数据绑定)
        - [渲染效果](/JavaReadingNotes/1482d2ca/#渲染效果)
        - [显示效果](/JavaReadingNotes/1482d2ca/#显示效果)
    - [select options绑定Object列表](/JavaReadingNotes/1482d2ca/#select-options绑定Object列表)
        - [测试链接](/JavaReadingNotes/1482d2ca/#测试链接)
        - [请求处理方法](/JavaReadingNotes/1482d2ca/#请求处理方法)
        - [表单标签](/JavaReadingNotes/1482d2ca/#表单标签)
        - [渲染效果](/JavaReadingNotes/1482d2ca/#渲染效果)
