...
- [4.1.8 radiobutton标签](/JavaReadingNotes/bcd20f0d/#4-1-8-radiobutton标签)
    - [测试链接](/JavaReadingNotes/bcd20f0d/#测试链接)
    - [域对象](/JavaReadingNotes/bcd20f0d/#域对象)
    - [请求处理方法](/JavaReadingNotes/bcd20f0d/#请求处理方法)
    - [绑定的表单](/JavaReadingNotes/bcd20f0d/#绑定的表单)
    - [渲染效果](/JavaReadingNotes/bcd20f0d/#渲染效果)
    - [显示效果](/JavaReadingNotes/bcd20f0d/#显示效果)
- [4.1.9radiobuttons标签](/JavaReadingNotes/bcd20f0d/#4-1-9radiobuttons标签)
    - [使用数组或集合作为数据源](/JavaReadingNotes/bcd20f0d/#使用数组或集合作为数据源)
        - [测试链接](/JavaReadingNotes/bcd20f0d/#测试链接)
        - [请求处理方法](/JavaReadingNotes/bcd20f0d/#请求处理方法)
        - [绑定的表单](/JavaReadingNotes/bcd20f0d/#绑定的表单)
        - [渲染效果](/JavaReadingNotes/bcd20f0d/#渲染效果)
        - [显示效果](/JavaReadingNotes/bcd20f0d/#显示效果)
    - [使用Map作为数据源](/JavaReadingNotes/bcd20f0d/#使用Map作为数据源)
        - [测试链接](/JavaReadingNotes/bcd20f0d/#测试链接)
        - [请求处理方法](/JavaReadingNotes/bcd20f0d/#请求处理方法)
        - [渲染结果](/JavaReadingNotes/bcd20f0d/#渲染结果)
    - [显示效果](/JavaReadingNotes/bcd20f0d/#显示效果)
