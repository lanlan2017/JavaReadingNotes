...
- [8.2 MyBatis入门](/JavaReadingNotes/c1d91609/#8-2-MyBatis入门)
    - [8.2.1 MyBatis下载和安装](/JavaReadingNotes/c1d91609/#8-2-1-MyBatis下载和安装)
        - [下载mybatis](/JavaReadingNotes/c1d91609/#下载mybatis)
        - [提示](/JavaReadingNotes/c1d91609/#提示)
        - [下载MySQL驱动](/JavaReadingNotes/c1d91609/#下载MySQL驱动)
        - [下载log4j](/JavaReadingNotes/c1d91609/#下载log4j)
- [MyBatis的数据库操作入门](/JavaReadingNotes/c1d91609/#MyBatis的数据库操作入门)
    - [项目结构](/JavaReadingNotes/c1d91609/#项目结构)
    - [引入jar文件到lib目录](/JavaReadingNotes/c1d91609/#引入jar文件到lib目录)
        - [引入mybatis的jar文件](/JavaReadingNotes/c1d91609/#引入mybatis的jar文件)
        - [引入mysql驱动](/JavaReadingNotes/c1d91609/#引入mysql驱动)
        - [引入log4j的jar包](/JavaReadingNotes/c1d91609/#引入log4j的jar包)
    - [持久化对象 PO](/JavaReadingNotes/c1d91609/#持久化对象-PO)
    - [创建数据库](/JavaReadingNotes/c1d91609/#创建数据库)
- [创建一个数据库,指定数据库的字符为真正的utf-8编码](/JavaReadingNotes/c1d91609/#创建一个数据库,指定数据库的字符为真正的utf-8编码)
    - [创建数据表](/JavaReadingNotes/c1d91609/#创建数据表)
- [如果有同名表,则删掉](/JavaReadingNotes/c1d91609/#如果有同名表,则删掉)
- [创建表](/JavaReadingNotes/c1d91609/#创建表)
    - [持久化类](/JavaReadingNotes/c1d91609/#持久化类)
    - [映射持久化类和数据表](/JavaReadingNotes/c1d91609/#映射持久化类和数据表)
        - [namespace属性](/JavaReadingNotes/c1d91609/#namespace属性)
        - [insert标签](/JavaReadingNotes/c1d91609/#insert标签)
    - [Mybatis根配置文件](/JavaReadingNotes/c1d91609/#Mybatis根配置文件)
        - [配置文件详解](/JavaReadingNotes/c1d91609/#配置文件详解)
        - [数据源介绍](/JavaReadingNotes/c1d91609/#数据源介绍)
    - [MyBatisTest.java](/JavaReadingNotes/c1d91609/#MyBatisTest-java)
    - [显示执行的SQL语句](/JavaReadingNotes/c1d91609/#显示执行的SQL语句)
- [全局的日志配置](/JavaReadingNotes/c1d91609/#全局的日志配置)
- [Mybatis的日志配置](/JavaReadingNotes/c1d91609/#Mybatis的日志配置)
- [控制台输出](/JavaReadingNotes/c1d91609/#控制台输出)
    - [运行效果](/JavaReadingNotes/c1d91609/#运行效果)
- [使用MyBatis持久化操作步骤](/JavaReadingNotes/c1d91609/#使用MyBatis持久化操作步骤)
- [MyBatis相较JDBC的优点](/JavaReadingNotes/c1d91609/#MyBatis相较JDBC的优点)
