...
- [13.2 数据表和持久化类](/JavaReadingNotes/a9fcda4f/#13-2-数据表和持久化类)
    - [13.2.1 设计数据库表](/JavaReadingNotes/a9fcda4f/#13-2-1-设计数据库表)
    - [13.2.2 设计持久化实体](/JavaReadingNotes/a9fcda4f/#13-2-2-设计持久化实体)
    - [13.2.3 创建持久化实体类](/JavaReadingNotes/a9fcda4f/#13-2-3-创建持久化实体类)
        - [User.java](/JavaReadingNotes/a9fcda4f/#User-java)
        - [Dept.java](/JavaReadingNotes/a9fcda4f/#Dept-java)
        - [Job.java](/JavaReadingNotes/a9fcda4f/#Job-java)
        - [Employee.java](/JavaReadingNotes/a9fcda4f/#Employee-java)
        - [Notice.java](/JavaReadingNotes/a9fcda4f/#Notice-java)
        - [Document.java](/JavaReadingNotes/a9fcda4f/#Document-java)
