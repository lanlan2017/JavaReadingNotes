...
- [10.1.3 多对多](/JavaReadingNotes/18ab9715/#10-1-3-多对多)
- [示例: ManyToManyTest](/JavaReadingNotes/18ab9715/#示例-ManyToManyTest)
    - [创建数据库表](/JavaReadingNotes/18ab9715/#创建数据库表)
- [创建用户表](/JavaReadingNotes/18ab9715/#创建用户表)
- [插入用户](/JavaReadingNotes/18ab9715/#插入用户)
- [创建商品表](/JavaReadingNotes/18ab9715/#创建商品表)
- [插入商品](/JavaReadingNotes/18ab9715/#插入商品)
- [创建订单表](/JavaReadingNotes/18ab9715/#创建订单表)
- [插入订单](/JavaReadingNotes/18ab9715/#插入订单)
- [创建订单-商品关系表](/JavaReadingNotes/18ab9715/#创建订单-商品关系表)
- [插入商品-订单](/JavaReadingNotes/18ab9715/#插入商品-订单)
    - [创建持久化类](/JavaReadingNotes/18ab9715/#创建持久化类)
        - [创建持久化类User.java](/JavaReadingNotes/18ab9715/#创建持久化类User-java)
        - [创建持久化类Order.java](/JavaReadingNotes/18ab9715/#创建持久化类Order-java)
        - [创建持久化类Article.java](/JavaReadingNotes/18ab9715/#创建持久化类Article-java)
    - [创建XML映射文件](/JavaReadingNotes/18ab9715/#创建XML映射文件)
        - [UserMapper.xml](/JavaReadingNotes/18ab9715/#UserMapper-xml)
        - [OrderMapper.xml](/JavaReadingNotes/18ab9715/#OrderMapper-xml)
        - [ArticleMapper.xml](/JavaReadingNotes/18ab9715/#ArticleMapper-xml)
    - [编写Mapper接口](/JavaReadingNotes/18ab9715/#编写Mapper接口)
        - [UserMapper接口](/JavaReadingNotes/18ab9715/#UserMapper接口)
        - [OrderMapper接口](/JavaReadingNotes/18ab9715/#OrderMapper接口)
    - [编写测试类](/JavaReadingNotes/18ab9715/#编写测试类)
- [总结](/JavaReadingNotes/18ab9715/#总结)
    - [collection标签](/JavaReadingNotes/18ab9715/#collection标签)
        - [collection标签的属性](/JavaReadingNotes/18ab9715/#collection标签的属性)
        - [collection标签的子标签](/JavaReadingNotes/18ab9715/#collection标签的子标签)
    - [association标签](/JavaReadingNotes/18ab9715/#association标签)
        - [association标签的属性](/JavaReadingNotes/18ab9715/#association标签的属性)
        - [association标签的子标签](/JavaReadingNotes/18ab9715/#association标签的子标签)
