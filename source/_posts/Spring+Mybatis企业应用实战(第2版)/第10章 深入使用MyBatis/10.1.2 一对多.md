...
- [10.1.2 一对多](/JavaReadingNotes/26e4bb72/#10-1-2-一对多)
- [示例:OneToManyTest](/JavaReadingNotes/26e4bb72/#示例-OneToManyTest)
    - [创建数据库表](/JavaReadingNotes/26e4bb72/#创建数据库表)
- [取消外键检查](/JavaReadingNotes/26e4bb72/#取消外键检查)
- [创建tb_clazz表](/JavaReadingNotes/26e4bb72/#创建tb-clazz表)
- [插入数据到tb_clazz表](/JavaReadingNotes/26e4bb72/#插入数据到tb-clazz表)
    - [创建持久化对象](/JavaReadingNotes/26e4bb72/#创建持久化对象)
    - [创建XML映射文件](/JavaReadingNotes/26e4bb72/#创建XML映射文件)
        - [ClazzMapper.xml](/JavaReadingNotes/26e4bb72/#ClazzMapper-xml)
            - [属性](/JavaReadingNotes/26e4bb72/#属性)
                - [属性](/JavaReadingNotes/26e4bb72/#属性)
        - [MyBatis根配置文件中支持懒加载](/JavaReadingNotes/26e4bb72/#MyBatis根配置文件中支持懒加载)
        - [StudentMapper.xml](/JavaReadingNotes/26e4bb72/#StudentMapper-xml)
        - [提示](/JavaReadingNotes/26e4bb72/#提示)
    - [创建mapper接口对象](/JavaReadingNotes/26e4bb72/#创建mapper接口对象)
        - [ClazzMapper接口](/JavaReadingNotes/26e4bb72/#ClazzMapper接口)
        - [StudentMapper接口](/JavaReadingNotes/26e4bb72/#StudentMapper接口)
    - [测试类](/JavaReadingNotes/26e4bb72/#测试类)
    - [运行结果](/JavaReadingNotes/26e4bb72/#运行结果)
- [总结](/JavaReadingNotes/26e4bb72/#总结)
    - [collection标签](/JavaReadingNotes/26e4bb72/#collection标签)
        - [collection标签的属性](/JavaReadingNotes/26e4bb72/#collection标签的属性)
        - [collection标签的子标签](/JavaReadingNotes/26e4bb72/#collection标签的子标签)
    - [association标签](/JavaReadingNotes/26e4bb72/#association标签)
        - [association标签的属性](/JavaReadingNotes/26e4bb72/#association标签的属性)
        - [association标签的子标签](/JavaReadingNotes/26e4bb72/#association标签的子标签)
