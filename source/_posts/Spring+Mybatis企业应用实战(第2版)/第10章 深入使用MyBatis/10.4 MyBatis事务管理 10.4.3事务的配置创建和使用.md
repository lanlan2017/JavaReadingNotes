...
- [10.4 MyBatis事务管理 10.4.3事务的配置创建和使用](/JavaReadingNotes/74600339/#10-4-MyBatis事务管理-10-4-3事务的配置创建和使用)
    - [1.事务的配置](/JavaReadingNotes/74600339/#1-事务的配置)
        - [如何查看mybatis源码](/JavaReadingNotes/74600339/#如何查看mybatis源码)
    - [2.事务工厂的创建](/JavaReadingNotes/74600339/#2-事务工厂的创建)
    - [3.事务工厂TransactionFactory](/JavaReadingNotes/74600339/#3-事务工厂TransactionFactory)
    - [4.JdbcTransaction](/JavaReadingNotes/74600339/#4-JdbcTransaction)
    - [5.ManagedTransaction](/JavaReadingNotes/74600339/#5-ManagedTransaction)
