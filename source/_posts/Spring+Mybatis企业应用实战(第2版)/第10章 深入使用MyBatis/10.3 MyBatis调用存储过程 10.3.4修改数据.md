...
- [10.3 MyBatis调用存储过程 10.3.4修改数据](/JavaReadingNotes/2e1d9c72/#10-3-MyBatis调用存储过程-10-3-4修改数据)
    - [注意](/JavaReadingNotes/2e1d9c72/#注意)
    - [xml映射](/JavaReadingNotes/2e1d9c72/#xml映射)
    - [mapper接口方法](/JavaReadingNotes/2e1d9c72/#mapper接口方法)
    - [测试类](/JavaReadingNotes/2e1d9c72/#测试类)
    - [运行结果](/JavaReadingNotes/2e1d9c72/#运行结果)
