...
- [10.5 MyBatis缓存机制](/JavaReadingNotes/5205dd1c/#10-5-MyBatis缓存机制)
- [10.5.1一级缓存(SqlSession级别)](/JavaReadingNotes/5205dd1c/#10-5-1一级缓存-SqlSession级别)
    - [缓存机制](/JavaReadingNotes/5205dd1c/#缓存机制)
    - [示例: OneLevelCacheTest](/JavaReadingNotes/5205dd1c/#示例-OneLevelCacheTest)
        - [环境搭建](/JavaReadingNotes/5205dd1c/#环境搭建)
- [创建数据库表](/JavaReadingNotes/5205dd1c/#创建数据库表)
- [插入数据](/JavaReadingNotes/5205dd1c/#插入数据)
        - [测试从一级缓存中查询数据](/JavaReadingNotes/5205dd1c/#测试从一级缓存中查询数据)
        - [执行DML语句时会自动清空缓存](/JavaReadingNotes/5205dd1c/#执行DML语句时会自动清空缓存)
        - [调用SqlSession的clearCache方法手动清除一级缓存](/JavaReadingNotes/5205dd1c/#调用SqlSession的clearCache方法手动清除一级缓存)
        - [关闭SqlSession时缓存会被清空](/JavaReadingNotes/5205dd1c/#关闭SqlSession时缓存会被清空)
