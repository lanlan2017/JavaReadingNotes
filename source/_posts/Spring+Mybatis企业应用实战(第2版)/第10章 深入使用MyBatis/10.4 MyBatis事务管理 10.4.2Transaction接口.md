...
- [10.4 MyBatis事务管理 10.4.2Transaction接口](/JavaReadingNotes/b24d3608/#10-4-MyBatis事务管理-10-4-2Transaction接口)
    - [数据库事务动作](/JavaReadingNotes/b24d3608/#数据库事务动作)
    - [Transaction接口](/JavaReadingNotes/b24d3608/#Transaction接口)
    - [MyBatis事务管理机制](/JavaReadingNotes/b24d3608/#MyBatis事务管理机制)
