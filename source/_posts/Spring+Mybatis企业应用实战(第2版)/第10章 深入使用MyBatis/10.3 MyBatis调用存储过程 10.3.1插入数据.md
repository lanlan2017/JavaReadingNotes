...
- [10.3 MyBatis调用存储过程](/JavaReadingNotes/3025e48/#10-3-MyBatis调用存储过程)
- [10.3.1插入数据](/JavaReadingNotes/3025e48/#10-3-1插入数据)
    - [测试数据](/JavaReadingNotes/3025e48/#测试数据)
- [创建数据表](/JavaReadingNotes/3025e48/#创建数据表)
- [插入数据](/JavaReadingNotes/3025e48/#插入数据)
    - [创建存储过程](/JavaReadingNotes/3025e48/#创建存储过程)
        - [存储过程代码详解](/JavaReadingNotes/3025e48/#存储过程代码详解)
        - [命令行调用存储过程](/JavaReadingNotes/3025e48/#命令行调用存储过程)
        - [显示存储过程的输出](/JavaReadingNotes/3025e48/#显示存储过程的输出)
    - [创建持久化对象](/JavaReadingNotes/3025e48/#创建持久化对象)
    - [编写Mapper.xml映射文件](/JavaReadingNotes/3025e48/#编写Mapper-xml映射文件)
    - [编写mapper接口](/JavaReadingNotes/3025e48/#编写mapper接口)
    - [编写测试类](/JavaReadingNotes/3025e48/#编写测试类)
    - [运行效果](/JavaReadingNotes/3025e48/#运行效果)
