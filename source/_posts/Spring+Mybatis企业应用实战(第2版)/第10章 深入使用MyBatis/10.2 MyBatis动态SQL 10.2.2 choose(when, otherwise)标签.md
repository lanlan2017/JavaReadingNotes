...
- [10.2 MyBatis动态SQL 10.2.2 choose(when, otherwise)](/JavaReadingNotes/4ab1747f/#10-2-MyBatis动态SQL-10-2-2-choose-when,-otherwise)
    - [测试choose标签](/JavaReadingNotes/4ab1747f/#测试choose标签)
        - [select标签](/JavaReadingNotes/4ab1747f/#select标签)
        - [mapper接口方法](/JavaReadingNotes/4ab1747f/#mapper接口方法)
        - [测试类](/JavaReadingNotes/4ab1747f/#测试类)
