...
- [10.1 MyBatis关联映射](/JavaReadingNotes/3de7370b/#10-1-MyBatis关联映射)
    - [什么是关联关系](/JavaReadingNotes/3de7370b/#什么是关联关系)
    - [关联关系分类](/JavaReadingNotes/3de7370b/#关联关系分类)
- [10.1.1 一对一联系](/JavaReadingNotes/3de7370b/#10-1-1-一对一联系)
    - [示例: OneToOneTest](/JavaReadingNotes/3de7370b/#示例-OneToOneTest)
        - [创建数据库表](/JavaReadingNotes/3de7370b/#创建数据库表)
- [创建tb_card表](/JavaReadingNotes/3de7370b/#创建tb-card表)
- [插入一条数据](/JavaReadingNotes/3de7370b/#插入一条数据)
- [创建tb_person表](/JavaReadingNotes/3de7370b/#创建tb-person表)
- [插入一条数据](/JavaReadingNotes/3de7370b/#插入一条数据)
        - [创建持久化类](/JavaReadingNotes/3de7370b/#创建持久化类)
        - [XML映射文件](/JavaReadingNotes/3de7370b/#XML映射文件)
        - [mapper接口](/JavaReadingNotes/3de7370b/#mapper接口)
        - [测试类](/JavaReadingNotes/3de7370b/#测试类)
