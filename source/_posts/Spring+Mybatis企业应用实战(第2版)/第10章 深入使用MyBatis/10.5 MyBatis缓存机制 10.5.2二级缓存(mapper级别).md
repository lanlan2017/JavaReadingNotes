...
- [10.5 MyBatis缓存机制 10.5.2二级缓存(mapper级别)](/JavaReadingNotes/b12f38ab/#10-5-MyBatis缓存机制-10-5-2二级缓存-mapper级别)
- [如何设置二级缓存](/JavaReadingNotes/b12f38ab/#如何设置二级缓存)
    - [在mybatis-config.xml中设置开启二级缓存](/JavaReadingNotes/b12f38ab/#在mybatis-config-xml中设置开启二级缓存)
    - [在Mapper.xml映射文件中加入cache标签](/JavaReadingNotes/b12f38ab/#在Mapper-xml映射文件中加入cache标签)
        - [默认的二级缓存作用](/JavaReadingNotes/b12f38ab/#默认的二级缓存作用)
        - [cache标签的属性](/JavaReadingNotes/b12f38ab/#cache标签的属性)
        - [使用二级缓存的的Java对象必须可序列化](/JavaReadingNotes/b12f38ab/#使用二级缓存的的Java对象必须可序列化)
- [实例](/JavaReadingNotes/b12f38ab/#实例)
    - [项目结构](/JavaReadingNotes/b12f38ab/#项目结构)
    - [初始化数据库表](/JavaReadingNotes/b12f38ab/#初始化数据库表)
- [创建数据库表](/JavaReadingNotes/b12f38ab/#创建数据库表)
- [插入数据](/JavaReadingNotes/b12f38ab/#插入数据)
    - [数据库配置文件](/JavaReadingNotes/b12f38ab/#数据库配置文件)
    - [log4j.xml](/JavaReadingNotes/b12f38ab/#log4j-xml)
    - [mybatis-config.xml](/JavaReadingNotes/b12f38ab/#mybatis-config-xml)
    - [User.java](/JavaReadingNotes/b12f38ab/#User-java)
    - [工具类](/JavaReadingNotes/b12f38ab/#工具类)
    - [mapper.xml](/JavaReadingNotes/b12f38ab/#mapper-xml)
    - [mapper接口](/JavaReadingNotes/b12f38ab/#mapper接口)
    - [测试类](/JavaReadingNotes/b12f38ab/#测试类)
    - [代码详解](/JavaReadingNotes/b12f38ab/#代码详解)
