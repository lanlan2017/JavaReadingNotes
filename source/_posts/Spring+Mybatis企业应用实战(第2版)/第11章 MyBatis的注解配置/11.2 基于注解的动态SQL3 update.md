...
- [11.2 基于注解的动态SQL3 update](/JavaReadingNotes/317a55b2/#11-2-基于注解的动态SQL3-update)
    - [生成动态SQL的方法](/JavaReadingNotes/317a55b2/#生成动态SQL的方法)
    - [mapper接口方法](/JavaReadingNotes/317a55b2/#mapper接口方法)
    - [测试类](/JavaReadingNotes/317a55b2/#测试类)
    - [运行效果](/JavaReadingNotes/317a55b2/#运行效果)
