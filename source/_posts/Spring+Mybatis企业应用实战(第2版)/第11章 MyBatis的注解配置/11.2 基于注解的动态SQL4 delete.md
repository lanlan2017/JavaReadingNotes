...
- [11.2 基于注解的动态SQL4 delete](/JavaReadingNotes/99881554/#11-2-基于注解的动态SQL4-delete)
    - [生成动态SQL的方法](/JavaReadingNotes/99881554/#生成动态SQL的方法)
    - [mapper接口方法](/JavaReadingNotes/99881554/#mapper接口方法)
    - [测试类](/JavaReadingNotes/99881554/#测试类)
    - [运行结果](/JavaReadingNotes/99881554/#运行结果)
