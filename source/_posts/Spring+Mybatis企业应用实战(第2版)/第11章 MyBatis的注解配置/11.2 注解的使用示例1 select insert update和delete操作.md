...
- [11.2 注解的使用](/JavaReadingNotes/f646a666/#11-2-注解的使用)
- [示例:测试 select,insert,update和delete操作](/JavaReadingNotes/f646a666/#示例-测试-select,insert,update和delete操作)
    - [项目搭建](/JavaReadingNotes/f646a666/#项目搭建)
        - [数据库表](/JavaReadingNotes/f646a666/#数据库表)
- [创建数据库表](/JavaReadingNotes/f646a666/#创建数据库表)
- [插入数据](/JavaReadingNotes/f646a666/#插入数据)
        - [持久化对象](/JavaReadingNotes/f646a666/#持久化对象)
        - [mapper接口](/JavaReadingNotes/f646a666/#mapper接口)
        - [mybatis-cofig.xml](/JavaReadingNotes/f646a666/#mybatis-cofig-xml)
        - [数据库信息配置文件db.properties](/JavaReadingNotes/f646a666/#数据库信息配置文件db-properties)
- [保存为db.properties文件,然后在mybatis-config.xml中通过下面标签引入:](/JavaReadingNotes/f646a666/#保存为db-properties文件,然后在mybatis-config-xml中通过下面标签引入)
- [<properties resource="db.properties"/>](/JavaReadingNotes/f646a666/#<properties-resource="db-properties"->)
        - [log4j.xml](/JavaReadingNotes/f646a666/#log4j-xml)
        - [工具类](/JavaReadingNotes/f646a666/#工具类)
    - [测试select功能](/JavaReadingNotes/f646a666/#测试select功能)
        - [数据表列名和持久化对象属性名相同的情况](/JavaReadingNotes/f646a666/#数据表列名和持久化对象属性名相同的情况)
    - [测试insert](/JavaReadingNotes/f646a666/#测试insert)
        - [mapper接口方法](/JavaReadingNotes/f646a666/#mapper接口方法)
        - [测试类](/JavaReadingNotes/f646a666/#测试类)
    - [测试update](/JavaReadingNotes/f646a666/#测试update)
        - [测试类](/JavaReadingNotes/f646a666/#测试类)
    - [测试delete](/JavaReadingNotes/f646a666/#测试delete)
        - [mapper接口方法](/JavaReadingNotes/f646a666/#mapper接口方法)
        - [测试类](/JavaReadingNotes/f646a666/#测试类)
    - [全部查询](/JavaReadingNotes/f646a666/#全部查询)
        - [接口方法](/JavaReadingNotes/f646a666/#接口方法)
        - [测试类](/JavaReadingNotes/f646a666/#测试类)
