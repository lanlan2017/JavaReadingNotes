...
- [11.2 注解的使用示例5 测试动态SQL](/JavaReadingNotes/e757c688/#11-2-注解的使用示例5-测试动态SQL)
    - [SQL类](/JavaReadingNotes/e757c688/#SQL类)
- [搭建基本项目框架](/JavaReadingNotes/e757c688/#搭建基本项目框架)
    - [项目结构](/JavaReadingNotes/e757c688/#项目结构)
    - [数据库表](/JavaReadingNotes/e757c688/#数据库表)
- [创建数据表](/JavaReadingNotes/e757c688/#创建数据表)
- [插入数据](/JavaReadingNotes/e757c688/#插入数据)
    - [持久化对象](/JavaReadingNotes/e757c688/#持久化对象)
    - [工具类](/JavaReadingNotes/e757c688/#工具类)
    - [mybatis相关配置文件](/JavaReadingNotes/e757c688/#mybatis相关配置文件)
        - [数据库信息属性文件db.properties](/JavaReadingNotes/e757c688/#数据库信息属性文件db-properties)
- [保存为db.properties文件,然后在mybatis-config.xml中通过下面标签引入:](/JavaReadingNotes/e757c688/#保存为db-properties文件,然后在mybatis-config-xml中通过下面标签引入)
- [<properties resource="db.properties"/>](/JavaReadingNotes/e757c688/#<properties-resource="db-properties"->)
- [下面的标签放在mybatis-config.xml文件的environments标签的environment子标签的子标签dataSource标签中](/JavaReadingNotes/e757c688/#下面的标签放在mybatis-config-xml文件的environments标签的environment子标签的子标签dataSource标签中)
- [<property name="driver" value="${driver}"/><property name="url" value="${url}"/><property name="username" value="${username}"/><property name="password" value="${password}"/>](/JavaReadingNotes/e757c688/#<property-name="driver"-value="$-driver-"-><property-name="url"-value="$-url-"-><property-name="username"-value="$-username-"-><property-name="password"-value="$-password-"->)
        - [log4j.xml](/JavaReadingNotes/e757c688/#log4j-xml)
        - [mybatis-config.xml](/JavaReadingNotes/e757c688/#mybatis-config-xml)
    - [EmployeeMapper接口](/JavaReadingNotes/e757c688/#EmployeeMapper接口)
    - [动态SQL生成器](/JavaReadingNotes/e757c688/#动态SQL生成器)
        - [动态SQL方法写法](/JavaReadingNotes/e757c688/#动态SQL方法写法)
