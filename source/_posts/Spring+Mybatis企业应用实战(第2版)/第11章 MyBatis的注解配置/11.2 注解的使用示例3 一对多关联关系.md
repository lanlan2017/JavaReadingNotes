...
- [11.2 注解的使用示例3 一对多关联关系](/JavaReadingNotes/d9b66b83/#11-2-注解的使用示例3-一对多关联关系)
- [示例:一对多关联关系](/JavaReadingNotes/d9b66b83/#示例-一对多关联关系)
    - [项目结构](/JavaReadingNotes/d9b66b83/#项目结构)
    - [数据库脚本](/JavaReadingNotes/d9b66b83/#数据库脚本)
- [创建tb_clazz表](/JavaReadingNotes/d9b66b83/#创建tb-clazz表)
- [插入数据到tb_clazz表](/JavaReadingNotes/d9b66b83/#插入数据到tb-clazz表)
    - [db.properties](/JavaReadingNotes/d9b66b83/#db-properties)
- [保存为db.properties文件,然后在mybatis-config.xml中通过下面标签引入:](/JavaReadingNotes/d9b66b83/#保存为db-properties文件,然后在mybatis-config-xml中通过下面标签引入)
- [<properties resource="db.properties"/>](/JavaReadingNotes/d9b66b83/#<properties-resource="db-properties"->)
    - [log4j.xml](/JavaReadingNotes/d9b66b83/#log4j-xml)
    - [mybatis-config.xml](/JavaReadingNotes/d9b66b83/#mybatis-config-xml)
    - [持久化对象](/JavaReadingNotes/d9b66b83/#持久化对象)
        - [Clazz.java](/JavaReadingNotes/d9b66b83/#Clazz-java)
        - [Student.java](/JavaReadingNotes/d9b66b83/#Student-java)
    - [会话工具类](/JavaReadingNotes/d9b66b83/#会话工具类)
    - [mapper接口](/JavaReadingNotes/d9b66b83/#mapper接口)
        - [ClazzMapper.java](/JavaReadingNotes/d9b66b83/#ClazzMapper-java)
        - [StudentMapper.java](/JavaReadingNotes/d9b66b83/#StudentMapper-java)
    - [测试类](/JavaReadingNotes/d9b66b83/#测试类)
        - [查询班级](/JavaReadingNotes/d9b66b83/#查询班级)
        - [查询学生](/JavaReadingNotes/d9b66b83/#查询学生)
