...
updated: 2020-06-07 05:09:44
---
<div id='my_toc'><a href="/JavaReadingNotes/null/#2-6-6-request对象" class="header_1">2.6.6 request对象</a>&nbsp;<br><a href="/JavaReadingNotes/null/#1-获取请求头-获取请求参数" class="header_1">1. 获取请求头 获取请求参数</a>&nbsp;<br><a href="/JavaReadingNotes/null/#获取请求参数方法" class="header_2">获取请求参数方法</a>&nbsp;<br><a href="/JavaReadingNotes/null/#获取请求头方法" class="header_2">获取请求头方法</a>&nbsp;<br><a href="/JavaReadingNotes/null/#请求头和请求参数的区别" class="header_2">请求头和请求参数的区别</a>&nbsp;<br><a href="/JavaReadingNotes/null/#GET请求POST请求" class="header_2">GET请求POST请求</a>&nbsp;<br><a href="/JavaReadingNotes/null/#-GET-方式的请求" class="header_3">`GET`方式的请求</a>&nbsp;<br><a href="/JavaReadingNotes/null/#-POST-方式的请求" class="header_3">`POST`方式的请求</a>&nbsp;<br><a href="/JavaReadingNotes/null/#form-jsp" class="header_2">form.jsp</a>&nbsp;<br><a href="/JavaReadingNotes/null/#只有带有name属性的表单域才会生成请求参数" class="header_2">只有带有name属性的表单域才会生成请求参数</a>&nbsp;<br><a href="/JavaReadingNotes/null/#request1-jsp" class="header_2">request1.jsp</a>&nbsp;<br><a href="/JavaReadingNotes/null/#请求参数的字符集" class="header_2">请求参数的字符集</a>&nbsp;<br><a href="/JavaReadingNotes/null/#请求的字符集合表单页面的字符集一样" class="header_3">请求的字符集合表单页面的字符集一样</a>&nbsp;<br><a href="/JavaReadingNotes/null/#测试" class="header_2">测试</a>&nbsp;<br><a href="/JavaReadingNotes/null/#request2-jsp" class="header_2">request2.jsp</a>&nbsp;<br><a href="/JavaReadingNotes/null/#获取GET的请求参数值" class="header_2">获取GET的请求参数值</a>&nbsp;<br><a href="/JavaReadingNotes/null/#request3-jsp" class="header_3">request3.jsp</a>&nbsp;<br></div>
