...
abbrlink: 34bd845a
---
- [18.4 使用反射生成并操作对象 18.4.3 访问成员变量值](/ReadingNotes/34bd845a/#18-4-使用反射生成并操作对象-18-4-3-访问成员变量值)
- [Field类](/ReadingNotes/34bd845a/#Field类)
    - [访问基本类型的成员变量](/ReadingNotes/34bd845a/#访问基本类型的成员变量)
    - [访问引用类型的成员变量](/ReadingNotes/34bd845a/#访问引用类型的成员变量)
    - [程序示例](/ReadingNotes/34bd845a/#程序示例)
        - [代码详解](/ReadingNotes/34bd845a/#代码详解)
    - [总结](/ReadingNotes/34bd845a/#总结)
