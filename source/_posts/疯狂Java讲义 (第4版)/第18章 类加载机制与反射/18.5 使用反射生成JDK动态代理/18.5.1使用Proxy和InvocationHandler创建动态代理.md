...
- [18.5.1使用Proxy和InvocationHandler创建动态代理](/JavaReadingNotes/dddab4ac/#18-5-1使用Proxy和InvocationHandler创建动态代理)
    - [创建动态代理类和动态代理实例的方法](/JavaReadingNotes/dddab4ac/#创建动态代理类和动态代理实例的方法)
    - [每个代理对象都有一个与之关联的InvocationHandler对象](/JavaReadingNotes/dddab4ac/#每个代理对象都有一个与之关联的InvocationHandler对象)
    - [本文重点](/JavaReadingNotes/dddab4ac/#本文重点)
