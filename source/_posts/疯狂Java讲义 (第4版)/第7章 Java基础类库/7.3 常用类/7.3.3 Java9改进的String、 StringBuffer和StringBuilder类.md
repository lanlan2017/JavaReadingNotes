...
- [7.3.3 Java9改进的String StringBuffer和StringBuilder类](/JavaReadingNotes/dc99ad78/#7-3-3-Java9改进的String-StringBuffer和StringBuilder类)
    - [String介绍](/JavaReadingNotes/dc99ad78/#String介绍)
    - [StringBuffer介绍](/JavaReadingNotes/dc99ad78/#StringBuffer介绍)
    - [StringBuilder和StringBuffer的不同](/JavaReadingNotes/dc99ad78/#StringBuilder和StringBuffer的不同)
    - [CharSequence接口介绍](/JavaReadingNotes/dc99ad78/#CharSequence接口介绍)
    - [java9对字符串类的改进](/JavaReadingNotes/dc99ad78/#java9对字符串类的改进)
- [String API详解](/JavaReadingNotes/dc99ad78/#String-API详解)
    - [String类构造器](/JavaReadingNotes/dc99ad78/#String类构造器)
    - [String类方法](/JavaReadingNotes/dc99ad78/#String类方法)
        - [根据下标获取一个字符](/JavaReadingNotes/dc99ad78/#根据下标获取一个字符)
        - [复制字符序列到字符数组的方法](/JavaReadingNotes/dc99ad78/#复制字符序列到字符数组的方法)
        - [获取字符长度的方法](/JavaReadingNotes/dc99ad78/#获取字符长度的方法)
        - [比较是否相同的方法](/JavaReadingNotes/dc99ad78/#比较是否相同的方法)
        - [生成新字符串的方法](/JavaReadingNotes/dc99ad78/#生成新字符串的方法)
        - [静态方法](/JavaReadingNotes/dc99ad78/#静态方法)
        - [比较大小方法](/JavaReadingNotes/dc99ad78/#比较大小方法)
        - [查找字符出现位置的方法](/JavaReadingNotes/dc99ad78/#查找字符出现位置的方法)
        - [大小写转换方法](/JavaReadingNotes/dc99ad78/#大小写转换方法)
        - [转成字节数组或字符数组的方法](/JavaReadingNotes/dc99ad78/#转成字节数组或字符数组的方法)
        - [判断是否带前缀或后缀](/JavaReadingNotes/dc99ad78/#判断是否带前缀或后缀)
- [StringBuffer和StringBuilder](/JavaReadingNotes/dc99ad78/#StringBuffer和StringBuilder)
    - [StringBuilder和StringBuffer的属性](/JavaReadingNotes/dc99ad78/#StringBuilder和StringBuffer的属性)
    - [StringBuilder方法详解](/JavaReadingNotes/dc99ad78/#StringBuilder方法详解)
        - [追加方法](/JavaReadingNotes/dc99ad78/#追加方法)
        - [删除方法](/JavaReadingNotes/dc99ad78/#删除方法)
        - [插入方法](/JavaReadingNotes/dc99ad78/#插入方法)
        - [查找下标方法](/JavaReadingNotes/dc99ad78/#查找下标方法)
        - [获取或设置字符方法](/JavaReadingNotes/dc99ad78/#获取或设置字符方法)
        - [容量和长度相关方法](/JavaReadingNotes/dc99ad78/#容量和长度相关方法)
        - [截取子串方法](/JavaReadingNotes/dc99ad78/#截取子串方法)
        - [反转方法](/JavaReadingNotes/dc99ad78/#反转方法)
        - [替换方法](/JavaReadingNotes/dc99ad78/#替换方法)
        - [重写的Object方法](/JavaReadingNotes/dc99ad78/#重写的Object方法)
        - [代码点相关方法](/JavaReadingNotes/dc99ad78/#代码点相关方法)
        - [其他方法](/JavaReadingNotes/dc99ad78/#其他方法)
        - [**StringBuilder**与**String**之间区别](/JavaReadingNotes/dc99ad78/#StringBuilder与String之间区别)
