...
- [7.5.2 使用正则表达式](/JavaReadingNotes/bdd8f31f/#7-5-2-使用正则表达式)
    - [直接使用Pattern类的静态matches方法](/JavaReadingNotes/bdd8f31f/#直接使用Pattern类的静态matches方法)
    - [Pattern类线程安全](/JavaReadingNotes/bdd8f31f/#Pattern类线程安全)
    - [Matcher类常用方法](/JavaReadingNotes/bdd8f31f/#Matcher类常用方法)
    - [CharSequence接口](/JavaReadingNotes/bdd8f31f/#CharSequence接口)
    - [实例](/JavaReadingNotes/bdd8f31f/#实例)
    - [find方法](/JavaReadingNotes/bdd8f31f/#find方法)
    - [开发一个简单网络爬虫的思路](/JavaReadingNotes/bdd8f31f/#开发一个简单网络爬虫的思路)
    - [matches和lookingAt方法的区别](/JavaReadingNotes/bdd8f31f/#matches和lookingAt方法的区别)
    - [reset方法](/JavaReadingNotes/bdd8f31f/#reset方法)
