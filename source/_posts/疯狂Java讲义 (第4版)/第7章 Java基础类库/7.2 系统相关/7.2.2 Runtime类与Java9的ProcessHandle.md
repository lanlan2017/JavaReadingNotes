...
- [7.2.2 Runtime类与Java9的ProcessHandle](/JavaReadingNotes/416eb659/#7-2-2-Runtime类与Java9的ProcessHandle)
    - [垃圾回收方法](/JavaReadingNotes/416eb659/#垃圾回收方法)
    - [加载文件和加载动态链接库方法](/JavaReadingNotes/416eb659/#加载文件和加载动态链接库方法)
    - [访问JVM相关信息](/JavaReadingNotes/416eb659/#访问JVM相关信息)
    - [启动进程运行命令](/JavaReadingNotes/416eb659/#启动进程运行命令)
        - [实例](/JavaReadingNotes/416eb659/#实例)
    - [获取**exec**启动的进程信息](/JavaReadingNotes/416eb659/#获取exec启动的进程信息)
        - [获取Process对象](/JavaReadingNotes/416eb659/#获取Process对象)
    - [如何获取ProcessHandle对象](/JavaReadingNotes/416eb659/#如何获取ProcessHandle对象)
- [实例 执行进程并返回进程的输出](/JavaReadingNotes/416eb659/#实例-执行进程并返回进程的输出)
    - [被调用的进程](/JavaReadingNotes/416eb659/#被调用的进程)
    - [编译 打包 测试](/JavaReadingNotes/416eb659/#编译-打包-测试)
    - [调用进程](/JavaReadingNotes/416eb659/#调用进程)
    - [工具类 运行进程并返回进程的标准输出](/JavaReadingNotes/416eb659/#工具类-运行进程并返回进程的标准输出)
    - [测试类](/JavaReadingNotes/416eb659/#测试类)
    - [Runtime方式和ProcessBuilder方式的对比](/JavaReadingNotes/416eb659/#Runtime方式和ProcessBuilder方式的对比)
        - [ProcessBuilder设置命令比较方便](/JavaReadingNotes/416eb659/#ProcessBuilder设置命令比较方便)
        - [ProcessBuilder可以指定工作目录](/JavaReadingNotes/416eb659/#ProcessBuilder可以指定工作目录)
