...
- [7.4.2 Calendar类](/JavaReadingNotes/ab9972d8/#7-4-2-Calendar类)
    - [推荐使用公历](/JavaReadingNotes/ab9972d8/#推荐使用公历)
    - [公历GregorianCalendar类](/JavaReadingNotes/ab9972d8/#公历GregorianCalendar类)
    - [可以知己扩展Calendar类](/JavaReadingNotes/ab9972d8/#可以知己扩展Calendar类)
    - [通过getInstance方法创建Calendar实例](/JavaReadingNotes/ab9972d8/#通过getInstance方法创建Calendar实例)
    - [Calendar和Date的相互转换](/JavaReadingNotes/ab9972d8/#Calendar和Date的相互转换)
        - [通过Calendar的getTime方法直接取出Date](/JavaReadingNotes/ab9972d8/#通过Calendar的getTime方法直接取出Date)
    - [先创建Calendar实例,再通过setTime方法将Date设置到Calendar实例中](/JavaReadingNotes/ab9972d8/#先创建Calendar实例,再通过setTime方法将Date设置到Calendar实例中)
    - [Calendar类常用方法](/JavaReadingNotes/ab9972d8/#Calendar类常用方法)
- [1. add与roll的区别](/JavaReadingNotes/ab9972d8/#1-add与roll的区别)
    - [add方法](/JavaReadingNotes/ab9972d8/#add方法)
    - [add方法的规则](/JavaReadingNotes/ab9972d8/#add方法的规则)
    - [roll方法的规则](/JavaReadingNotes/ab9972d8/#roll方法的规则)
    - [2. 设置Calendar的容错性](/JavaReadingNotes/ab9972d8/#2-设置Calendar的容错性)
        - [setLenient方法](/JavaReadingNotes/ab9972d8/#setLenient方法)
        - [两种解释日历的模式](/JavaReadingNotes/ab9972d8/#两种解释日历的模式)
- [3. set()方法延迟修改](/JavaReadingNotes/ab9972d8/#3-set-方法延迟修改)
