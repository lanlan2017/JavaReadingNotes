...
- [5.6 类的继承](/JavaReadingNotes/a9f29b11/#5-6-类的继承)
- [5.6.1 继承的特点](/JavaReadingNotes/a9f29b11/#5-6-1-继承的特点)
    - [继承关键字](/JavaReadingNotes/a9f29b11/#继承关键字)
    - [继承语法格式](/JavaReadingNotes/a9f29b11/#继承语法格式)
    - [extends关键字也可以叫扩展](/JavaReadingNotes/a9f29b11/#extends关键字也可以叫扩展)
    - [默认父类](/JavaReadingNotes/a9f29b11/#默认父类)
