...
- [5.4.2 使用访问控制符](/JavaReadingNotes/8aac6014/#5-4-2-使用访问控制符)
    - [当前类访问权限private](/JavaReadingNotes/8aac6014/#当前类访问权限private)
    - [包访问权限default](/JavaReadingNotes/8aac6014/#包访问权限default)
    - [子类访问权限protected](/JavaReadingNotes/8aac6014/#子类访问权限protected)
    - [公共访问权限public](/JavaReadingNotes/8aac6014/#公共访问权限public)
    - [访问控制级别汇总表](/JavaReadingNotes/8aac6014/#访问控制级别汇总表)
    - [访问控制符用于修饰类的成员](/JavaReadingNotes/8aac6014/#访问控制符用于修饰类的成员)
        - [不要使用访问控制符修饰局部变量](/JavaReadingNotes/8aac6014/#不要使用访问控制符修饰局部变量)
    - [外部类只能使用public或默认修饰](/JavaReadingNotes/8aac6014/#外部类只能使用public或默认修饰)
    - [public修饰的类的源文件名必须与类名相同](/JavaReadingNotes/8aac6014/#public修饰的类的源文件名必须与类名相同)
    - [setter getter方法](/JavaReadingNotes/8aac6014/#setter-getter方法)
        - [setter和getter方法的命名规则](/JavaReadingNotes/8aac6014/#setter和getter方法的命名规则)
        - [什么是符合JavaBean规范的类](/JavaReadingNotes/8aac6014/#什么是符合JavaBean规范的类)
    - [高内聚 低耦合](/JavaReadingNotes/8aac6014/#高内聚-低耦合)
        - [什么是高内聚](/JavaReadingNotes/8aac6014/#什么是高内聚)
        - [什么是低耦合](/JavaReadingNotes/8aac6014/#什么是低耦合)
    - [应该使用private修饰符的情况](/JavaReadingNotes/8aac6014/#应该使用private修饰符的情况)
    - [应该使用protected修饰符的情况](/JavaReadingNotes/8aac6014/#应该使用protected修饰符的情况)
    - [应该使用public修饰的情况](/JavaReadingNotes/8aac6014/#应该使用public修饰的情况)
