...
- [8.1 Java集合概述](/JavaReadingNotes/df371140/#8-1-Java集合概述)
    - [数组无法存放数量变化的数据](/JavaReadingNotes/df371140/#数组无法存放数量变化的数据)
    - [集合有什么用](/JavaReadingNotes/df371140/#集合有什么用)
    - [集合类的包](/JavaReadingNotes/df371140/#集合类的包)
    - [集合类与数组的区别](/JavaReadingNotes/df371140/#集合类与数组的区别)
    - [集合类的两个根接口](/JavaReadingNotes/df371140/#集合类的两个根接口)
    - [Collection的子接口](/JavaReadingNotes/df371140/#Collection的子接口)
    - [Map接口](/JavaReadingNotes/df371140/#Map接口)
    - [访问各个集合中元素的区别](/JavaReadingNotes/df371140/#访问各个集合中元素的区别)
    - [集合的常见实现类](/JavaReadingNotes/df371140/#集合的常见实现类)
