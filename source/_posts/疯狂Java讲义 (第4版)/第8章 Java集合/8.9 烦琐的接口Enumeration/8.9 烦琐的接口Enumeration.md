...
- [8.9 烦琐的接口Enumeration](/JavaReadingNotes/3b9e0599/#8-9-烦琐的接口Enumeration)
    - [Enumeration接口方法](/JavaReadingNotes/3b9e0599/#Enumeration接口方法)
    - [不推荐使用Enumeration](/JavaReadingNotes/3b9e0599/#不推荐使用Enumeration)
    - [Enumeration迭代Vector和Hashtable](/JavaReadingNotes/3b9e0599/#Enumeration迭代Vector和Hashtable)
