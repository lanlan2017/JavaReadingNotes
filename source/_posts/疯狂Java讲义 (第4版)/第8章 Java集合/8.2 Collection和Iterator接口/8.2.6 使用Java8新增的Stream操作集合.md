...
- [8.2.6 使用Java 8新增的Stream操作集合](/JavaReadingNotes/b351b699/#8-2-6-使用Java-8新增的Stream操作集合)
    - [如何创建类型为int,long,double的Stream](/JavaReadingNotes/b351b699/#如何创建类型为int,long,double的Stream)
    - [独立使用Stream的步骤](/JavaReadingNotes/b351b699/#独立使用Stream的步骤)
    - [程序示例](/JavaReadingNotes/b351b699/#程序示例)
    - [中间方法和末端方法](/JavaReadingNotes/b351b699/#中间方法和末端方法)
    - [流的方法有什么特征](/JavaReadingNotes/b351b699/#流的方法有什么特征)
    - [Stream常用的中间方法](/JavaReadingNotes/b351b699/#Stream常用的中间方法)
    - [Stream常用的末端方法](/JavaReadingNotes/b351b699/#Stream常用的末端方法)
    - [如何获取集合对应的流](/JavaReadingNotes/b351b699/#如何获取集合对应的流)
    - [实例 使用流操作集合](/JavaReadingNotes/b351b699/#实例-使用流操作集合)
