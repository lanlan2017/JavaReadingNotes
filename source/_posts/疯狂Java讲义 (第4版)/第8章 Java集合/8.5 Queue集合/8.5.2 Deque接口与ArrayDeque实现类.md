...
- [8.5.2 Deque接口与ArrayDeque实现类](/JavaReadingNotes/674ed48/#8-5-2-Deque接口与ArrayDeque实现类)
    - [[Deque接口方法](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Deque.html](/JavaReadingNotes/674ed48/#[Deque接口方法]-https-docs-oracle-com-en-java-javase-11-docs-api-java-base-java-util-Deque-html)
    - [Deque的方法与Queue的方法对照](/JavaReadingNotes/674ed48/#Deque的方法与Queue的方法对照)
    - [Deque的方法与Stack的方法对照](/JavaReadingNotes/674ed48/#Deque的方法与Stack的方法对照)
- [ArrayDeque实现类](/JavaReadingNotes/674ed48/#ArrayDeque实现类)
    - [ArrayDeque当成栈使用](/JavaReadingNotes/674ed48/#ArrayDeque当成栈使用)
    - [需要**栈**时用**ArrayDeque**而不是Stack](/JavaReadingNotes/674ed48/#需要栈时用ArrayDeque而不是Stack)
    - [ArrayDeque当成队列使用](/JavaReadingNotes/674ed48/#ArrayDeque当成队列使用)
- [参考资料](/JavaReadingNotes/674ed48/#参考资料)
