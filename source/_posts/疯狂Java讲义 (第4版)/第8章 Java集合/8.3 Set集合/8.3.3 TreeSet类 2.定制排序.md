...
- [8.3.3 TreeSet类 2.定制排序](/JavaReadingNotes/c3abbdfa/#8-3-3-TreeSet类-2-定制排序)
    - [自然排序默认是升序排列的](/JavaReadingNotes/c3abbdfa/#自然排序默认是升序排列的)
    - [定制排序](/JavaReadingNotes/c3abbdfa/#定制排序)
    - [如何实现定制排序](/JavaReadingNotes/c3abbdfa/#如何实现定制排序)
    - [放入TreeSet中对象的类型要相同 不要往TreeSet中放入不同类型的对象](/JavaReadingNotes/c3abbdfa/#放入TreeSet中对象的类型要相同-不要往TreeSet中放入不同类型的对象)
    - [相等的元素不会再次添加到TreeSet中](/JavaReadingNotes/c3abbdfa/#相等的元素不会再次添加到TreeSet中)
