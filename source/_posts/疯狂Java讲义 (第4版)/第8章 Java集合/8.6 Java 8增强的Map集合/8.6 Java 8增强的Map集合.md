...
- [8.6 Java 8增强的Map集合](/JavaReadingNotes/b84b3341/#8-6-Java-8增强的Map集合)
    - [Map的key不可重复](/JavaReadingNotes/b84b3341/#Map的key不可重复)
    - [一个key对应一个value](/JavaReadingNotes/b84b3341/#一个key对应一个value)
    - [根据key取value](/JavaReadingNotes/b84b3341/#根据key取value)
    - [Map中的所有key可以看成一个Set集合](/JavaReadingNotes/b84b3341/#Map中的所有key可以看成一个Set集合)
        - [keySet()方法](/JavaReadingNotes/b84b3341/#keySet-方法)
    - [Java使用Map来实现Set](/JavaReadingNotes/b84b3341/#Java使用Map来实现Set)
    - [Map中的的所有value可以看成一个List集合](/JavaReadingNotes/b84b3341/#Map中的的所有value可以看成一个List集合)
    - [Map接口方法](/JavaReadingNotes/b84b3341/#Map接口方法)
        - [添加元素的方法](/JavaReadingNotes/b84b3341/#添加元素的方法)
        - [删除元素的方法](/JavaReadingNotes/b84b3341/#删除元素的方法)
        - [查询方法](/JavaReadingNotes/b84b3341/#查询方法)
    - [Map的实现类](/JavaReadingNotes/b84b3341/#Map的实现类)
    - [Map的内部类Entry](/JavaReadingNotes/b84b3341/#Map的内部类Entry)
    - [实例](/JavaReadingNotes/b84b3341/#实例)
- [参考资料](/JavaReadingNotes/b84b3341/#参考资料)
