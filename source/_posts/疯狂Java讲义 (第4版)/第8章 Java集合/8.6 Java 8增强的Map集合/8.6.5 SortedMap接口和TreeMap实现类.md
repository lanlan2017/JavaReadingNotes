...
- [8.6.5 SortedMap接口和TreeMap实现类](/JavaReadingNotes/50672106/#8-6-5-SortedMap接口和TreeMap实现类)
    - [TreeMap两种排序方式](/JavaReadingNotes/50672106/#TreeMap两种排序方式)
    - [TreeMap判断两个key相等的标准](/JavaReadingNotes/50672106/#TreeMap判断两个key相等的标准)
    - [compareTo方法比较大小](/JavaReadingNotes/50672106/#compareTo方法比较大小)
    - [作为key的自定义类的要求](/JavaReadingNotes/50672106/#作为key的自定义类的要求)
    - [Set和Map的关系](/JavaReadingNotes/50672106/#Set和Map的关系)
    - [返回key或Entry的方法](/JavaReadingNotes/50672106/#返回key或Entry的方法)
    - [截取子Map的方法](/JavaReadingNotes/50672106/#截取子Map的方法)
    - [实例](/JavaReadingNotes/50672106/#实例)
