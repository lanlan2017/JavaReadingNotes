...
- [8.6.6 WeakHashMap实现类](/JavaReadingNotes/554c719d/#8-6-6-WeakHashMap实现类)
    - [WeakHashMap和HashMap的区别](/JavaReadingNotes/554c719d/#WeakHashMap和HashMap的区别)
    - [实例](/JavaReadingNotes/554c719d/#实例)
    - [使用WeakHashMap要注意什么](/JavaReadingNotes/554c719d/#使用WeakHashMap要注意什么)
