...
- [6.1 Java8增强的包装类](/JavaReadingNotes/8cb4e34d/#6-1-Java8增强的包装类)
    - [8种基本数据类型不支持面向对象](/JavaReadingNotes/8cb4e34d/#8种基本数据类型不支持面向对象)
    - [所有的引用变量都可以当成Object类的引用变量使用](/JavaReadingNotes/8cb4e34d/#所有的引用变量都可以当成Object类的引用变量使用)
    - [包装类的引入](/JavaReadingNotes/8cb4e34d/#包装类的引入)
    - [基本数据类型和包装类的对应关系](/JavaReadingNotes/8cb4e34d/#基本数据类型和包装类的对应关系)
    - [基本数据类型和包装类的命名规则](/JavaReadingNotes/8cb4e34d/#基本数据类型和包装类的命名规则)
    - [JDK1.5之前 基本数据类型变成包装类对象](/JavaReadingNotes/8cb4e34d/#JDK1-5之前-基本数据类型变成包装类对象)
    - [JDK1.5之前 包装类对象转基本数据类型](/JavaReadingNotes/8cb4e34d/#JDK1-5之前-包装类对象转基本数据类型)
    - [自动装箱 自动拆箱](/JavaReadingNotes/8cb4e34d/#自动装箱-自动拆箱)
        - [什么是自动装箱](/JavaReadingNotes/8cb4e34d/#什么是自动装箱)
        - [什么是自动拆箱](/JavaReadingNotes/8cb4e34d/#什么是自动拆箱)
    - [自动装箱时注意类型匹配](/JavaReadingNotes/8cb4e34d/#自动装箱时注意类型匹配)
    - [字符串类型的值转为基本类型类型的值](/JavaReadingNotes/8cb4e34d/#字符串类型的值转为基本类型类型的值)
    - [基本类型变量转为字符串](/JavaReadingNotes/8cb4e34d/#基本类型变量转为字符串)
    - [包装类对象可以直接和基本类型直接比较](/JavaReadingNotes/8cb4e34d/#包装类对象可以直接和基本类型直接比较)
    - [比较两个包装类对象的值](/JavaReadingNotes/8cb4e34d/#比较两个包装类对象的值)
    - [系统会自动缓存负128到127的Integer对象](/JavaReadingNotes/8cb4e34d/#系统会自动缓存负128到127的Integer对象)
        - [Integer缓存引起的问题](/JavaReadingNotes/8cb4e34d/#Integer缓存引起的问题)
- [java版本对包装类的增强](/JavaReadingNotes/8cb4e34d/#java版本对包装类的增强)
    - [Java7后通过包装类的compare来比较对于基本类型的大小](/JavaReadingNotes/8cb4e34d/#Java7后通过包装类的compare来比较对于基本类型的大小)
    - [Java7为Character包装类增加了大量工具方法](/JavaReadingNotes/8cb4e34d/#Java7为Character包装类增加了大量工具方法)
    - [java8增加无符号运算](/JavaReadingNotes/8cb4e34d/#java8增加无符号运算)
    - [无符号整数的特点](/JavaReadingNotes/8cb4e34d/#无符号整数的特点)
