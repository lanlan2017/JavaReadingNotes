...
abbrlink: f2e9e8d2
---
<div id='my_toc'><a href="/JavaReadingNotes/f2e9e8d2/#16-6-3-使用阻塞队列-BlockingQueue-控制线程通信" class="header_1">16.6.3 使用阻塞队列(BlockingQueue)控制线程通信</a>&nbsp;<br><a href="/JavaReadingNotes/f2e9e8d2/#程序示例-ArrayBlockingQueue-阻塞队列" class="header_2">程序示例 `ArrayBlockingQueue`阻塞队列</a>&nbsp;<br><a href="/JavaReadingNotes/f2e9e8d2/#程序示例-使用-BlockingQueue-实现线程通信" class="header_2">程序示例 使用`BlockingQueue`实现线程通信</a>&nbsp;<br></div>
