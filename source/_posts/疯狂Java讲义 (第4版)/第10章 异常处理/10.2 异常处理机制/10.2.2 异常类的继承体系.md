...
- [10.2.2 异常类的继承体系](/JavaReadingNotes/4e094de3/#10-2-2-异常类的继承体系)
    - [出现异常时只会执行多个catch块中的一个](/JavaReadingNotes/4e094de3/#出现异常时只会执行多个catch块中的一个)
    - [不可省略try块和catch块后面的花括号](/JavaReadingNotes/4e094de3/#不可省略try块和catch块后面的花括号)
    - [try块中声明的变量只在该try块中有效](/JavaReadingNotes/4e094de3/#try块中声明的变量只在该try块中有效)
    - [错误](/JavaReadingNotes/4e094de3/#错误)
    - [NullPointerException](/JavaReadingNotes/4e094de3/#NullPointerException)
        - [什么时候会引发NullPointerException异常](/JavaReadingNotes/4e094de3/#什么时候会引发NullPointerException异常)
    - [先捕获小异常 再捕获大异常](/JavaReadingNotes/4e094de3/#先捕获小异常-再捕获大异常)
