...
- [10.2.7 Java 7的自动关闭资源的try语句](/JavaReadingNotes/655287c5/#10-2-7-Java-7的自动关闭资源的try语句)
    - [什么样的资源可以让try语句自动关闭](/JavaReadingNotes/655287c5/#什么样的资源可以让try语句自动关闭)
    - [Closeable和AutoCloseable的区别](/JavaReadingNotes/655287c5/#Closeable和AutoCloseable的区别)
    - [Java 7几乎所有的资源类都可以自动关闭](/JavaReadingNotes/655287c5/#Java-7几乎所有的资源类都可以自动关闭)
