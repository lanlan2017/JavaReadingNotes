...
- [13.2.5 数据库约束 4.FOREIGN KEY约束](/JavaReadingNotes/802c3714/#13-2-5-数据库约束-4-FOREIGN-KEY约束)
        - [从表](/JavaReadingNotes/802c3714/#从表)
    - [如何确定外键设置的位置](/JavaReadingNotes/802c3714/#如何确定外键设置的位置)
        - [一对多关联关系](/JavaReadingNotes/802c3714/#一对多关联关系)
        - [一对一关联关系](/JavaReadingNotes/802c3714/#一对一关联关系)
        - [多对多联系](/JavaReadingNotes/802c3714/#多对多联系)
    - [外键约束写在哪里](/JavaReadingNotes/802c3714/#外键约束写在哪里)
        - [列级约束语法建立外键约束](/JavaReadingNotes/802c3714/#列级约束语法建立外键约束)
        - [MySQL中外键约束正确语法](/JavaReadingNotes/802c3714/#MySQL中外键约束正确语法)
    - [指定外键约束的名字](/JavaReadingNotes/802c3714/#指定外键约束的名字)
    - [组合外键](/JavaReadingNotes/802c3714/#组合外键)
    - [删除外键约束](/JavaReadingNotes/802c3714/#删除外键约束)
    - [增加外键约束](/JavaReadingNotes/802c3714/#增加外键约束)
    - [自关联](/JavaReadingNotes/802c3714/#自关联)
    - [删除主表记录时从表记录也删除](/JavaReadingNotes/802c3714/#删除主表记录时从表记录也删除)
