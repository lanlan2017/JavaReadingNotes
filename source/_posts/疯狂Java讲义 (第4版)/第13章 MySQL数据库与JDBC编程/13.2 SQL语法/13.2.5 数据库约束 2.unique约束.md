...
- [13.2.5 数据库约束 2.UNIQUE约束](/JavaReadingNotes/b4c9e8dc/#13-2-5-数据库约束-2-UNIQUE约束)
    - [使用列级约束语法建立唯一约束](/JavaReadingNotes/b4c9e8dc/#使用列级约束语法建立唯一约束)
    - [表级约束语法建立唯一约束](/JavaReadingNotes/b4c9e8dc/#表级约束语法建立唯一约束)
    - [修改表结构时增加或删除唯一约束](/JavaReadingNotes/b4c9e8dc/#修改表结构时增加或删除唯一约束)
