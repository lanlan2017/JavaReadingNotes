...
- [13.2.5 数据库约束](/JavaReadingNotes/78ea4716/#13-2-5-数据库约束)
    - [5种完整性约束](/JavaReadingNotes/78ea4716/#5种完整性约束)
        - [MySQL不支持check约束](/JavaReadingNotes/78ea4716/#MySQL不支持check约束)
    - [约束分类](/JavaReadingNotes/78ea4716/#约束分类)
    - [什么时候指定约束](/JavaReadingNotes/78ea4716/#什么时候指定约束)
    - [1.NOT NULL约束](/JavaReadingNotes/78ea4716/#1-NOT-NULL约束)
        - [建表的时候指定NOT NULL约束](/JavaReadingNotes/78ea4716/#建表的时候指定NOT-NULL约束)
        - [alter table修改表时增加和删除非空约束](/JavaReadingNotes/78ea4716/#alter-table修改表时增加和删除非空约束)
            - [默认值](/JavaReadingNotes/78ea4716/#默认值)
                - [默认值](/JavaReadingNotes/78ea4716/#默认值)
            - [默认值](/JavaReadingNotes/78ea4716/#默认值)
                - [默认值](/JavaReadingNotes/78ea4716/#默认值)
