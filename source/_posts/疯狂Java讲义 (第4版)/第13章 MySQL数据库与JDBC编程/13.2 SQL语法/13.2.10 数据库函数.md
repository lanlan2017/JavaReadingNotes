...
- [13.2.10数据库函数](/JavaReadingNotes/1dace4b4/#13-2-10数据库函数)
    - [单行函数](/JavaReadingNotes/1dace4b4/#单行函数)
        - [单行函数分类](/JavaReadingNotes/1dace4b4/#单行函数分类)
- [长度,sin(长度)](/JavaReadingNotes/1dace4b4/#长度,sin-长度)
        - [处理null的函数](/JavaReadingNotes/1dace4b4/#处理null的函数)
        - [case函数](/JavaReadingNotes/1dace4b4/#case函数)
    - [小结](/JavaReadingNotes/1dace4b4/#小结)
