...
- [13.2.4 DDL语句 2.修改表结构的语法](/JavaReadingNotes/b7c5ba0f/#13-2-4-DDL语句-2-修改表结构的语法)
    - [增加列定义](/JavaReadingNotes/b7c5ba0f/#增加列定义)
        - [实例](/JavaReadingNotes/b7c5ba0f/#实例)
    - [修改列定义](/JavaReadingNotes/b7c5ba0f/#修改列定义)
        - [实例](/JavaReadingNotes/b7c5ba0f/#实例)
    - [删除列的语法](/JavaReadingNotes/b7c5ba0f/#删除列的语法)
        - [实例](/JavaReadingNotes/b7c5ba0f/#实例)
- [MySQL独有语法](/JavaReadingNotes/b7c5ba0f/#MySQL独有语法)
    - [重命名数据表](/JavaReadingNotes/b7c5ba0f/#重命名数据表)
        - [实例](/JavaReadingNotes/b7c5ba0f/#实例)
    - [改变列名](/JavaReadingNotes/b7c5ba0f/#改变列名)
        - [实例](/JavaReadingNotes/b7c5ba0f/#实例)
