...
- [13.2.8 DML语句语法](/JavaReadingNotes/ac781fff/#13-2-8-DML语句语法)
- [1.insert into语句](/JavaReadingNotes/ac781fff/#1-insert-into语句)
    - [注意](/JavaReadingNotes/ac781fff/#注意)
    - [插入指定列](/JavaReadingNotes/ac781fff/#插入指定列)
    - [插入所有列](/JavaReadingNotes/ac781fff/#插入所有列)
    - [实例](/JavaReadingNotes/ac781fff/#实例)
        - [插入主表](/JavaReadingNotes/ac781fff/#插入主表)
        - [向从表插入数据](/JavaReadingNotes/ac781fff/#向从表插入数据)
    - [设置外键不能插入null](/JavaReadingNotes/ac781fff/#设置外键不能插入null)
    - [带子查询的插入语句](/JavaReadingNotes/ac781fff/#带子查询的插入语句)
        - [子查询插入要求](/JavaReadingNotes/ac781fff/#子查询插入要求)
        - [插入失败自动增长列也会增长](/JavaReadingNotes/ac781fff/#插入失败自动增长列也会增长)
