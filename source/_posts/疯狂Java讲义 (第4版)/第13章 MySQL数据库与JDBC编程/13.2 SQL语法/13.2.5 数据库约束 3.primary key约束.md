...
- [13.2.5 数据库约束 3.PRIMARY KEY约束](/JavaReadingNotes/75a051a3/#13-2-5-数据库约束-3-PRIMARY-KEY约束)
    - [列级别约束创建主键约束](/JavaReadingNotes/75a051a3/#列级别约束创建主键约束)
    - [表级别约束创建主键约束](/JavaReadingNotes/75a051a3/#表级别约束创建主键约束)
    - [组合主键](/JavaReadingNotes/75a051a3/#组合主键)
    - [删除主键约束](/JavaReadingNotes/75a051a3/#删除主键约束)
    - [增加主键约束](/JavaReadingNotes/75a051a3/#增加主键约束)
        - [通过add添加主键约束](/JavaReadingNotes/75a051a3/#通过add添加主键约束)
        - [通过modify添加主键约束](/JavaReadingNotes/75a051a3/#通过modify添加主键约束)
    - [自动增长列](/JavaReadingNotes/75a051a3/#自动增长列)
