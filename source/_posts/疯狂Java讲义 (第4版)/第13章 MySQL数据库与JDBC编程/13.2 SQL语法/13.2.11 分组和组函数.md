...
- [13.2.11 分组和组函数](/JavaReadingNotes/d1920f7c/#13-2-11-分组和组函数)
    - [实例](/JavaReadingNotes/d1920f7c/#实例)
        - [sum函数](/JavaReadingNotes/d1920f7c/#sum函数)
        - [max函数](/JavaReadingNotes/d1920f7c/#max函数)
        - [min函数](/JavaReadingNotes/d1920f7c/#min函数)
        - [count方法](/JavaReadingNotes/d1920f7c/#count方法)
        - [avg方法](/JavaReadingNotes/d1920f7c/#avg方法)
    - [分组的情况](/JavaReadingNotes/d1920f7c/#分组的情况)
        - [根据某一列进行分组](/JavaReadingNotes/d1920f7c/#根据某一列进行分组)
        - [根据多列分组](/JavaReadingNotes/d1920f7c/#根据多列分组)
- [要求java_teacher,student_name这两列的值都相同的记录作为一组](/JavaReadingNotes/d1920f7c/#要求java-teacher,student-name这两列的值都相同的记录作为一组)
- [要求java_teacher,student_name这两列的值都相同的记录作为一组](/JavaReadingNotes/d1920f7c/#要求java-teacher,student-name这两列的值都相同的记录作为一组)
        - [处理不在group by以及组函数中的列](/JavaReadingNotes/d1920f7c/#处理不在group-by以及组函数中的列)
- [student_name这列没有出现在group by子句中,](/JavaReadingNotes/d1920f7c/#student-name这列没有出现在group-by子句中,)
- [也没有出现在分组函数count之中,](/JavaReadingNotes/d1920f7c/#也没有出现在分组函数count之中,)
- [MySQL将显示遇到的第一条记录时student_name的值。](/JavaReadingNotes/d1920f7c/#MySQL将显示遇到的第一条记录时student-name的值。)
- [也没有出现在分组函数count之中,](/JavaReadingNotes/d1920f7c/#也没有出现在分组函数count之中,)
- [MySQL将显示遇到的第一条记录时student_name的值。](/JavaReadingNotes/d1920f7c/#MySQL将显示遇到的第一条记录时student-name的值。)
    - [having子句](/JavaReadingNotes/d1920f7c/#having子句)
