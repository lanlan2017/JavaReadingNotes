...
- [13.9 使用连接池管理连接](/JavaReadingNotes/eeb78ea8/#13-9-使用连接池管理连接)
- [13.9.1 DBCP数据源](/JavaReadingNotes/eeb78ea8/#13-9-1-DBCP数据源)
    - [13.9.2 C3P0数据源](/JavaReadingNotes/eeb78ea8/#13-9-2-C3P0数据源)
        - [下载C3P0数据源](/JavaReadingNotes/eeb78ea8/#下载C3P0数据源)
